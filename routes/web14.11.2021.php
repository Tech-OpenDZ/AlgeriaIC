...
Route::group(['namespace' => 'Frontend','prefix' => LaravelLocalization::setLocale(),
    ...
    Route::get('/business-opportunity/sector/{sector_id}/details/{id}', 'BusinessOpportunityController@show')->name('business-opportunity-details')->middleware('auth:customer');
