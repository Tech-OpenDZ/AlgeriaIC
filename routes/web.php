...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['auth'] ], function () {
    ...
    Route::resource('manage-press', 'PressController')->except(['show']);
...
Route::group(['namespace' => 'Frontend','prefix' => LaravelLocalization::setLocale(),
    ...
    Route::post('/inquiry-success','HomeController@storeInquiry')->name('store-inquiry');
    ...
    Route::get('/subscription_pack', 'AuthController@subs_pack')->name('subscription-pack');

    Route::get('/checkout_succes',function() {
        return view('frontend.signup.returnUrl');
    })->name('returnUrl');

    Route::get('/checkout_failed',function() {
   ...
   Route::get('/business-opportunity/sector/{sector_id}/details/{id}', 'BusinessOpportunityController@show')->name('business-opportunity-details'); 
    ...
    Route::get('/about-teste',function() {
        return view('frontend.layouts.gallery');
    });


    Route::get('/naft_video_french',function() {
        return view('frontend.alnaft_video.index');
    })->name('naft_video_french');

    Route::get('/naft_video_english',function() {
        return view('frontend.alnaft_video.english');
    })->name('naft_video_english');
    ...
    Route::get('/qhse_new', 'QhseController@index_new')->name('qhse_new');
    /* ----------------------------Fin Route QHSE ----------------------------------*/
    ...
    Route::get('/videos_press', 'PressController@index')->name('videos_press');
    ...
    Route::get('/test_page',function() {
        return view('frontend.layouts.test_page');
    })->name('test_page');
