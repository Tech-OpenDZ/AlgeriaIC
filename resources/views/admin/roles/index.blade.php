...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label">Manage Role</h3>
		</div>
        @can('role-create')
   		...
   		<div class="dataTables_wrapper dt-bootstrap4 no-footer">
   			<div class="row">
   				<div class="col-sm-12 table-responsive">
		   			<table class="table table-bordered table-hover table-checkable" id="role_datatable">
...
<div id="roleModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form name='deleteRoleForm' id='deleteRoleForm'  method="POST">
                {{method_field('DELETE')}}
                {{ csrf_field() }}
...
$(document).ready(function(){
	$('body').on('click', ".delete_roles_btn", function(e) {
        e.stopPropagation();
        var del_id = $(this).data('id');
        $('#deleteRoleForm').attr('action', $(this).data('href'));
