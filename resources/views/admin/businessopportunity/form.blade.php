<form class="form">
    ...
    <div class="card-body">
        <div class="form-group row">
            <div class="col-lg-4">
                <div class="form-group">
                    <input type="hidden" name="englishTitle" value="{{isset($business_opportunity->project_title_in_english) ? $business_opportunity->project_title_in_english: ''}}">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                   <!-- {!! Form::label('project_description_in_english', 'Project Description (In english)',['class' => 'required-class']) !!}
                    ...
                    {!! Form::label('project_description_in_english', 'Project Description (In english)') !!}
                    {!! Form::label('', '*',['style' => 'color:red']) !!}
                    {!! Form::textarea('project_description_in_english',isset($business_opportunity->project_description_in_english) ? $business_opportunity->project_description_in_english: '' , ['class' => 'form-control summernote', 'id' => 'summernote-1','required','data-parsley-required-message'=>'project Description in english is required.']) !!}
                    @error('project_description_in_english')
                        <div class="bg-danger-o-50 py-2 px-4">{{ $message }}</div>
                    @enderror
            ...
            <div class="col-lg-12">
                <div class="form-group">
                   <!-- {!! Form::label('project_description_in_arabic', 'Project Description (In arabic)',['class' => 'required-class']) !!}
                    ...
                    {!! Form::label('project_description_in_arabic', 'Project Description (In arabic)',['class' => 'required-class']) !!}
                    {!! Form::label('', '*',['style' => 'color:red']) !!}
                    {!! Form::textarea('project_description_in_arabic',isset($business_opportunity->project_description_in_arabic) ? $business_opportunity->project_description_in_arabic: '' , ['class' => 'form-control summernote', 'id' => 'kt-summernote-2']) !!}
                    @error('project_description_in_arabic')
                    <div class="bg-danger-o-50 py-2 px-4">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                  <!--  {!! Form::label('project_description_in_french', 'Project Description (In french)',['class' => 'required-class']) !!}
                    {!! Form::label('', '*',['style' => 'color:red']) !!}
                    {!! Form::textarea('project_description_in_french', isset($business_opportunity->project_description_in_french) ? $business_opportunity->project_description_in_french : '', ['id' => 'project_description_in_french','class' => 'form-control']) !!}
                    @error('project_description_in_french')
                    <div class="bg-danger-o-50 py-2 px-4">{{ $message }}</div>
                    @enderror -->


                    {!! Form::label('project_description_in_french', 'Project Description (In french)') !!}
                    {!! Form::label('', '*',['style' => 'color:red']) !!}
                    {!! Form::textarea('project_description_in_french', isset($business_opportunity->project_description_in_french) ? $business_opportunity->project_description_in_french: '' , ['class' => 'form-control summernote', 'id' => 'summernote-3','required','data-parsley-required-message'=>'Project Description in french is required.']) !!}
                    @error('project_description_in_french')
                        <div class="bg-danger-o-50 py-2 px-4">{{ $message }}</div>
                    @enderror
        ...
        <div class="form-group">
            ...
            {!! Form::file('company_presentation_file',['class' =>'form-control','']) !!}
        ...
        <div class="form-group">
            {!! Form::label('', 'Documents') !!}<br /><br />
           
            {!! Form::file('documents[]',['class' =>'form-control','multiple']) !!}
            @error('documents.*')
            <div class="bg-danger-o-50 py-2 px-4">{{ $message }}</div>
            @enderror
