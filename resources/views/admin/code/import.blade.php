...
<div class="card card-custom gutter-b" style="width: 100%;margin: 0 auto;">
    ...
    {!! Form::open(array('method'=>'POST','route' => ['manage-code-import'],'files' => true)) !!}
      	<div class="card-body">
        	<div class="form-group">
        		<div class="col-lg-7">
				    {!! Form::label('logo', 'Choose File',['class' => 'required-class']) !!}
				    {!! Form::label('', '*',['style' => 'color:red']) !!} 
	        		<br/><br/>
				    {!! Form::file('file',['id' => 'logo','class' =>'form-control','data-parsley-required' => 'true']) !!}<br><br>
				     @error('file')
					 ...
					 <a class="btn btn-primary" href="{{ asset('code.xlsx') }}">Download</a>
				</div>
        	</div> 
        		<!-- <hr>     -->
        </div>
