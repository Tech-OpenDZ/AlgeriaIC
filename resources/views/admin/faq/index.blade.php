...
<div class="card card-custom gutter-b" style="width: 100%;margin: 0 auto;">
    <div class="card-header flex-wrap py-3">
        <div class="card-title">
            <h3 class="card-label">Manage FAQ
        </div>
        @can('faq-create')
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{route('manage-faq.create')}}" class="btn btn-primary">
                New FAQ
            </a>
            <!--end::Button-->
        </div>
        ...
        <div class="dataTables_wrapper dt-bootstrap4 no-footer">
            <div class="row">
                <div class="col-sm-12 table-responsive">
                    <table class="table table-bordered data-table" id="faq_datatable">
