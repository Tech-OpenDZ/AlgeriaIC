...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label">Manage Partner</h3>
		</div>
		@can('partner-create')
		<div class="card-toolbar">
			<a href="{{route('manage-partner.create')}}" class="btn btn-primary">
        ...
        <div class="modal-content">
            <form name='deletePartnerForm' id='deletePartnerForm'  method="POST">
                ...
                <div class="modal-body">
                    <p>Are you sure want to delete this partner?</p>
                </div>
...
$(function () {
    var table = $('#partner_datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "{{ route('manage-partner.index') }}",
          data: function (d){
