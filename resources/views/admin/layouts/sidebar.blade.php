...
<br>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-link active">
                        <a href="#" class="nav-link active" aria-current="page"> <i
                                    class="fas fa-money-bill-wave-alt"></i>
                            <svg class="bi me-2" width="16" height="16">
                                <use xlink:href="#home"/>
                            </svg>
        ...
        background-color:#dd4f41;
            ...
            <!-- <li class="menu-item {{ (request()->is('admin/manage-event')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                {{ (request()->is('admin/manage-content*')) ? 'menu-item-active menu-item-open' : ''}}
                            ...
                            ||  {{ (request()->is('admin/manage-press')) ? 'menu-item-active menu-item-open' : '' }}
            ...
            <!-- @can('user-list')
                ...
                @endcan-->
                    ...
                    @endcan
                    @can('advertisement-list')
                        <li class="menu-item {{ (request()->is('admin/manage-press')) ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{route('manage-press.index')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Devices\Video-camera.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <!--end::Svg Icon-->
                                ...
                                <span class="menu-text">Press videos </span>
                            </a>
                        </li>
                    @endcan
                    @can('newsletter-list')
