...
<br> <br>
        ...
        @if(isset($resource->id))
            {!! Form::label('', 'Selected Resource Images') !!}<br/><br/>
            <div class="form-group row">
            @foreach($resource->resourceImages as $resourceImage)
                <div class="form-group">
                    <div class="col-lg-3">
                        {!! Form::image('storage/uploads/business_environnement/'.$resourceImage->image,'resource_imge', array('width' => 100, 'height' => 100))!!} <br>
                        <a href="javascript:void(0)" data-id="{{$resourceImage->id}}" class="removeSelected"><i class="far fa-trash-alt" style="color: #F64E60;"></i></a>
                    </div>
                </div>
            @endforeach
        ...
        <div class="form-group">
            ...
            {!! Form::file('resource_image[]',['class' =>'form-control','multiple','id'=>'files','style'=>'display:none']) !!}
