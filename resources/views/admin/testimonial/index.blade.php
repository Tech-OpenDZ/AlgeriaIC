...
@php
    if (\Auth::user()->can('testimonial-edit') || \Auth::user()->can('testimonial-delete')) {
        $actionEnable = true;
    }
    else {
        $actionEnable = false;
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            <div class="card-title">
                <h3 class="card-label">Manage Testimonial
            </div>
            @can('testimonial-create')
            <div class="card-toolbar">

                <!--begin::Button-->
                <a href="{{route('manage-testimonial.create')}}" class="btn btn-primary">
                    New Testimonial
                </a>
                <!--end::Button-->
            </div>
...
@section('sctipts')
     ...
     <!-- Testimonial Delete confirmation model -->
    <div id="deleteTestimonialModal" class="modal fade delete_admin_btn" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form name='deleteTestimonialForm' id='deleteTestimonialForm'  method="POST">
                    {{method_field('DELETE')}}
                    {{ csrf_field() }}
    ...
    <script>
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('manage-testimonial.index') }}",
                    data: function (d) {
        ...
        $(document).on('click', ".delete_admin_btn", function(e) {
            ...
            $('#deleteTestimonialForm').attr('action', $(this).data('href'));
