...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"> Gestion des clients </h3>
		</div>
        @if ($subscription != [])
...
<center> <table>
<tr>
<td> <p style='font-size:15px'> <a href='#'> <strong> Nombre de tous les clients :   <a href='#' style='color:red'> $nbr </a>  </strong>   &nbsp;  &nbsp;   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </a> </p> </td>
...
?>
<!--<br><p style='font-size:15px'><a href='#'> <strong> Pour modifier un client ou ajouter un commentaire <a href='list' style='color:red'> Cliquez Ici </a> </strong>  </a> </p> </td>
</tr> -->
<style>
    a{
        color:black;
