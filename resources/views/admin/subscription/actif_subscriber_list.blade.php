...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"> Liste des clients actifs </h3>
		</div>
        @if ($subscription != [])
   ...
   <form method="POST" id="search-form" class="kt-form kt-form--fit mb-15" role="form">
   			<div class="row mb-6">
   				...
   				<div class="col-lg-3 mb-lg-0 mb-6">
                    ...
                    <!--<option class="form-control datatable-input payment_status" name="payment_status" value="completed"> Completed </option> -->
				</div>
                <div class="col-lg-3 mb-lg-0 mb-6">
                    ...
                    <option class="form-control datatable-input is_deactivated" name="is_deactivated" value="0"> Oui </option>
				</div>
   			</div>
   			<div class="row mt-8">
				<div class="col-lg-12">
...
/*              Listes des clients Actifs         */
      ...
      // echo "<td> <a href='actif_subscriber_list'> <strong> Nombre des clients actifs : <mark> $nbr1 </mark>   </strong>  &nbsp;  &nbsp;  &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </a> </td>";
        ...
        //echo "<td><a href='suspended_subscriber_list'> <strong> Nombre des clients suspendus : <mark> $nbr3  </mark> </strong>  <br> <br></a></td>";
            ...
            <td> <p style='font-size:15px'> <a href='new_subscriber_list'> <strong> Nombre des demandes en attente : <a href='new_subscriber_list' style='color:red'> $nbr2 </a>   </strong>   </a> </p>  </td>
            </tr>

            <tr>
            <td> <br><p style='font-size:15px'> <a href='#'> <strong> Nombre des clients actifs : <a href='#' style='color:red'> $nbr1 </a>  </strong> &nbsp;  &nbsp;   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </a> </p>  </td>
