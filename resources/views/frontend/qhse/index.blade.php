...
@section('content')
    ...
    <div class="business-directory-main">
        <div class="discover-algeria" style="padding-top: 0px;padding-bottom: 0px;">



            <div class="container" style="max-width:100%">
                <div class="row align-content-center justify-content-center"  style=" left:0;right:0;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
               
                    <div class="qhse_heading_new col-md-12" style="height:400px; width:100%">
                   
                        <div class="section_title text-center" style="padding-top:110px">
                          <h2 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;"> @lang('qhse.qhse_title')</h2>
                          
                            <br>

                        </div>
                        <span class="light-transparent_qhse"></span>
    ...
    .subtitle {
        ...
        padding-top: 80px!important;
                    ...
                    <div class="page-content" >
                        <div class="container" style="max-width:1170px;background-color:#FFFFFF">
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="page-content custom-bkg bkg-light-blue mb-0" style="max-width:100%;background-color:#f5f5f5">
                        <div class="container" >
                            <div class="row">
                                <div class="col-md-6">
                                    <br>
                    ...
                    <div class="container" style="max-width:1170px;background-color:#FFFFFF">
                        <div class="row">
                            <div class="line_left_3 col-md-6">
                                <br>
                                <br>
                                <div class="custom-heading">
                            ...
                            <div class="line_right_3 col-md-6 animated triggerAnimation zoomIn" data-animate="zoomIn" style="opacity: 1;">
                                <br>
                                <br>
                        ...
                        <div class="container" >
                            ...
                            <div class="row" align="center">
                                 ...
                                 <div class="custom-heading02" style="text-align: center!important;" >
                                    <br>
                                    <br>
                                    <h2 class="only_lg" style="text-align:center">  &nbsp; @lang('qhse.certifications') </h2>
                            ...
                            <div class="row iso_line" style="width:100%!important">
                    ...
                    <div class="page-content custom-bkg bkg-light-blue mb-0" style="width:100%!important">
                            <div class="container" style="max-width:1170px;background-color:#FFFFFF">
                                <div class="row">
                                    <div class="line_left_4 col-md-9">
                                        <br>
                                        <br>
                                        <div class="custom-heading">
                                  ...
                                  <div class="line_right_4 col-md-3">
                                      <br>
                                      <br>
                                        <div class="custom-heading">
