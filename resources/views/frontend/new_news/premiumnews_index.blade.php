                ...
                <div class="row" style="background-color:#ffffff;margin-left: -15px;margin-right:-15px">
                    <div class="expert_heading" style="height:400px; width:100%;padding-top:70px">
                        <div class="section_title" style="padding-top:125px">
                            <h2 class="subtitle align-content-center justify-content-center" style="color:#FFFFFF;font-weight:bold">@lang('news.premiumNews')</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="discover-algeria__left">
                        ...
                        <section class="news-inside-post" id="news-list-data">
                            ...
                            <div class="slider-area table-carousel">
                                <div id="table-slide">
                                    <!-- The slideshow -->
                                    <div class="carousel-inner mt-4" id="carousel-inner-data">
                                    <div class="row mt-4">
