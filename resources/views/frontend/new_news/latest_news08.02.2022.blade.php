                        ...
                        <div class="col-xl-7 col-lg-10 col-md-9 col-sm-10 col-12">
                            <div class="news-post__right">
                                ...
                                <p class="news-time">{{Carbon\Carbon::parse($latest_news[$i]->created_at)->diffForHumans()}}</p>
                                    ...
                                    @if($latest_news[$i]->is_premium == 1)
                                      <a href="{{route('premium-news-detail', [$latest_news[$i]->page_key])}}">
                                         <h6 class="news-text-heading-two text-limit-three" style="-webkit-line-clamp:3">{{ html_entity_decode(strip_tags($latest_news[$i]->localeAll[0]->title)) }}</h6>
                                      </a>
                                      <span>
                                        <a href="#" class="premium-eco">@lang('news.premiumNews')</a>
                                    </span>
                                    @else
                                        <a href="{{route('news-detail', [$latest_news[$i]->page_key])}}">
                                           <h6 class="news-text-heading-two text-limit-three" style="-webkit-line-clamp:3">{{ html_entity_decode(strip_tags($latest_news[$i]->localeAll[0]->title)) }}  <br>  <br> </h6>    
                                        </a>  
                                ...
                                <a href="{{$latest_news[$i]->source_link}}" target="_blank"><p class=""><img src="{{asset('storage/uploads/news_source/logo/'.$latest_news[$i]->newsSource->logo)}}"  alt="algeria-logo" class="" height="20%" width="30%" style="float:right"></p></a>
                            </div>
                        ...
                        <div class="col-xl-7 col-lg-10 col-md-9 col-sm-10 col-12">
                            <div class="news-post__right">
                                ...
                                <p class="news-time">{{Carbon\Carbon::parse($latest_news[$i]->created_at)->diffForHumans()}}</p>
                                    ...
                                    @if($latest_news[$i]->is_premium == 1)
                                      <a href="{{route('premium-news-detail', [$latest_news[$i]->page_key])}}">
                                         <h6 class="news-text-heading-two text-limit-three" style="-webkit-line-clamp:3">{{ html_entity_decode(strip_tags($latest_news[$i]->localeAll[0]->title)) }}</h6></a>
                                         <span>
                                        <a href="#" class="premium-eco">@lang('news.premiumNews')</a>
                                    </span>
                                    @else
