         ...
         <div class="discover-algeria" style="padding-top:0px;padding-bottom:0px;background-color:#ffffff!important">
             <div class="container_contact" style="max-width:100%!important">
                <div class="row" style="background-color:#ffffff;margin-left: -15px;margin-right: -15px">
                    <div class="news_heading" style="height:400px; width:100%;padding-top:70px">
                        <div class="section_title" style="padding-top:125px">
                            <h2 class="subtitle align-content-center justify-content-center" style="color:#FFFFFF;font-weight:bold">@lang('news.news')</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <section class="news-inside-post" id="news-list-data">
                                ...
                                <div class="slider-area table-carousel">
                                    <div id="table-slide">
                                        ...
                                        @if ($latestNews != '')
                                        <div class="row mt-4">
                                          <div class="col-lg-8 col-md-8 col-ms-12 mt-4">
                                         
                                                <h4 class="main-heading">@lang('news.latestNewsLabel')</h4>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-ms-12 mt-4">
                                        ...
                                        @endif
                                           ...
                                           <!-- latest news ends here -->
                                            <h4 class="main-heading">@lang('news.moreNewsLabel')</h4>
                                            <br>
                                               {!! $moreNews !!}
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '#previous-page-more-news', function(e){
                ...
                window.location.href = '{{route("news-list")}}?page='+'{{$news->currentPage()-1}}'+currentURL;
            });
