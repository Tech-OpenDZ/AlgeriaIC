                    ...
                    <div class="row" style="background-color:#ffffff;margin-left: -15px;margin-right: -15px">
                        <div class="register_heading" style="height:400px; width:100%;padding-top:70px">
                            <div class="section_title" style="padding-top:125px;">
                                <h2 class="subtitle align-content-center justify-content-center" style="color:#FFFFFF;font-weight:bold;">@lang('signup.registrationForm')</h2>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="page-content" >
                        <div class="container" style="max-width:1170px;background-color:transparent">
                               <div class="row form-row"  style="padding-left:10px;padding-top: 80px;padding-bottom: 50px;">
                                    <div class="col-md-12">
                                        <span class="anchor" id="formUserEdit"></span>

                                                      <!-- form user info -->
                                             <div class="card card-outline-secondaryv" style="max-width:1140px;border: 1px solid #f5f5f5;">
                                                      ...
                                                      <div class="card-body" style="margin-right:0px;margin-left:0px;border-right: 5px solid #0795fe;border-top-left-radius:20px;border-bottom-left-radius:20px;color:#000000;text-transform: bold;box-shadow: 0px 10px 60px 0px rgb(0 0 0 / 10%) ">
                                                            ...
                                                            <br>
                                                                        ...
                                                                        <form autocomplete="off" class="form-horizontal" role="form" method="post" action="{{ route('customer-store') }}">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                        <select class="form-control" id="contact-inquiry" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none" name="contact-inquiry" onchange="showDiv(this)">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" class="form-control @error('name') is-invalid  @enderror"  id="name" name="name" value="{{ old('name') }}" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                                        @error('name')
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" class="form-control @error('companyName') is-invalid  @enderror"  id="companyName" name="companyName" value="{{ old('companyName') }}" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                                        @error('companyName')
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" class="form-control @error('jobTitle') is-invalid  @enderror"  id="jobTitle" name="jobTitle" value="{{ old('jobTitle') }}" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                                        @error('jobTitle')
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" class="form-control @error('address') is-invalid  @enderror"  id="address" name="address" value="{{ old('address') }}" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                                        @error('address')
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-3">
                                                                                        ...
                                                                                        <select name="pays" class="form-control @error('pays') is-invalid  @enderror" id="pays" onchange="choseCountry(this.value,0)" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                                    ...
                                                                                    <div class="col-lg-3">
                                                                                        ...
                                                                                        <option value="#">
                                                                                            ...
                                                                                            Algiers
                                                                                                            ...
                                                                                                            <select name="wilaya" class="form-control" id="wilaya" onchange="choseCommune(this.value,0)" hidden style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" class="form-control @error('phone') is-invalid  @enderror"  id="phone" name="phone" value="{{ old('phone') }}" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                                        @error('phone')
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <input type="email" class="form-control @error('email_customer') is-invalid  @enderror"  id="email_customer" name="email_customer" value="{{ old('email_customer') }}" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" class="form-control @error('username') is-invalid  @enderror"  id="username" name="username" value="{{ old('username') }}" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                                        @error('username')
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <div>
                                                                                            <input type="password" id="password-field"  class="form-control @error('password') is-invalid  @enderror"  id="password" name="password" value="{{ old('password') }}" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none"> <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span> </div>
                                                                                        @error('password')
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <select class="form-control" id="provenance" name="provenance" onchange="showDiv(this)" style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input type="text" class="form-control @error('other_provenance') is-invalid  @enderror" placeholder="@lang('signup.other_origin2') " id="other_provenance" name="other_provenance" value="{{ old('other_provenance') }}" hidden style="background-color: #e9eef4;color: #686a6f;font-size: 0.9rem;width: 100%;border: none">
                                                                            ...
                                                                            <br>
                                                                                ...
                                                                                <div class="form-check mb-2 mr-sm-2" >
                                                                                    <label class="form-check-label">
                                                                                        ...
                                                                                        <p class="label-text-check" inline> &nbsp <strong>  <a href="#"  id="sauve_news"  style="color:#140c40" class="label-text-check-anchor test">@lang('footer.subscribeNewsletter')</a> </p> </strong>
                                                                                ...
                                                                                <div class="form-check mb-2 mr-sm-2" >
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox"  class="form-check-input @error('company_type') is-invalid  @enderror" style="top: 8px;" name="company_type" value="algerian" id="company_type">
                                                                                        <p class="label-text-check" inline> &nbsp <strong>  <a href="#"  id=""  style="color:#140c40" class="label-text-check-anchor test">@lang('signup.view_payment_mode') (@lang('signup.algerianCompanies'))</a> </p> </strong>
                                                                                        @error('company_type')
                                                                                        <span class="invalid-feedback" role="alert" id="company_type-validation-error">
                                                                                            {{ $message }}
                                                                                        </span>
                                                                                        @enderror
                                                                    ...
                                                                    <div class="form-card">
                                                                        <div class="signup-form-area text-left">
                                                                            <div class="" id="PaymentSection" hidden>
                                                                                <h4 class="main-heading"  style="color:#000000;text-transform: bold; text-shadow: 10px 10px 10px rgb(0 0 0 / 20%);text-align:center;"> <center> <b> @lang('signup.selectPaymentMethod')</b> </center></h4>
                                                                                ...
                                                                                <div class="signup-form-area__elements pt-4">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <!--<div class="col-md-4">
                                                                                                <label class="radio-inline d-flex align-items-center">
                                                                                                    <input type="checkbox" name="company_type" value="algerian" checked><h4 class="sub-heading ml-2"> @lang('signup.algerianCompanies')</h4>
                                                                                                </label>
                                                                                            </div> -->
                                                                                    ...
                                                                                    <div class="mode-selection">
                                                                                        <div class="mod-selection__top">
                                                                                            ...
                                                                                            <ul class="nav nav-pills mb-3 mode-selection__elements" id="pills-tab" role="tablist">
                                                                                                ...
                                                                                                <!--<li class="nav-item not-allowed">
                                                                                                    ...
                                                                                                    <label class="nav-link offline-mode-box">
                                                                                                        <input  type="radio" name="chooseOffline" id="nullrad" value="NULL" hidden checked>
                                                                                                        <span class="NULL">
                                                                                        ...
                                                                                        <div class="mod-selection__mid">
                                                                                            ...
                                                                                            <ul class="nav nav-pills mb-3 mode-selection__elements" id="pills-tab" role="tablist">
                                                                                                <li class="nav-item not-allowed">
                                                                                                    <label class="nav-link offline-mode-box card-list">
                                                                                                        <input id="pills-credit-card-tab" type="radio" name="chooseOnline" id="cibrad" value="carteCIB">
                                                                                                        <span class="credit-card"> Carte CIB </span>
                                                                                                        <br>
                                                                                                        <br>
                                                                                                        <img class="payment-logo" src="{{asset('storage/uploads/cib_logos/Logo_Interoperabilite_Final.png')}}" alt="">
                                                                                                    </label>
                                                                                                </li>
                                                                                            <!-- <li class="nav-item not-allowed">
                                                                                                    <label class="nav-link offline-mode-box card-list">
                                                                                                        <input id="pills-debit-card" type="radio" name="chooseOnline" value="carteEdahabia">
                                                                                                        <span class="debit-card"> Carte EDAHABIA</span>
                                                                                                        <br>
                                                                                                        <br>
                                                                                                        <img class="payment-logo" src="{{asset('storage/uploads/cib_logos/ccp.satim_logo.png')}}" alt="">
                                                                                        ...
                                                                                        <!-- <h4 class="sub-heading-two mt-4 mb-2">@lang('press_review.selectCurrency')</h4> -->
                                                                                            ...
                                                                                            <ul class="currency-detail mode-selection__elements" id="">
                                                                                                ...
                                                                                                <li class="currency-display">
                                                                                                    <h4 class="sub-heading-two mt-3 mb-2"> Montant</h4>
                                                                                                    <h6 class="currency-text">
                                                                                                        59.381,00 DZD
                                                                                                        <input type="hidden" id="currency-value" name="price" value="59381">
                                                                                                        <span class="" id="currency-value-span"></span>
                                                                                                        <span class="" id="currency-unit"> @lang('signup.dzd')</span>
                                                                                                    </h6>
                                                                                                </li>
                                                                    ...
                                                                    <button type="submit" class="next action-button continue" id="continue_button_main">@lang('signup.continue')</button> -->
                                                                            ...
                                                                            <div class="form-check mb-2 mr-sm-2" >
                                                                                <label class="form-check-label">
                                                                                    ...
                                                                                    <p class="label-text-check" inline> &nbsp <strong>  <a href="{{route('terms-of-service')}}"  style="color:#140c40" target="_blank" id="sauve" class="label-text-check-anchor">@lang('signup.iAccept') @lang('signup.generalConditions')</a> </p> </strong>
                                                                                ...
                                                                                <center><div class="form-group row" style="center:center; width:150px;text-align:center" >
                                                                                    ...
                                                                                    <!-- <input class="btn btn-secondary" type="reset" value="Cancel"> -->
                                                                                        <input type="submit" class="genric-btn success radius" id="register_button" value="ENVOYER" target="_blank" >
...
document.getElementById('company_type').onchange = function () 
{
    ...
    if ($(this).is(":checked"))
    {
        ...
        //document.getElementById("company_type").value = "algerian";
