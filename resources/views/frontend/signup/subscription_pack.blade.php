            ...
            <div class="row" style="background-color:#ffffff;margin-left: -15px;margin-right: -15px">
                <div class="register_heading" style="height:400px; width:100%;padding-top:70px">
                    <div class="section_title" style="padding-top:125px">
                         <h2 class="subtitle align-content-center justify-content-center" style="color:#FFFFFF;font-weight:bold">@lang('signup.package') </h2>
                    </div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-9">
                                                ...
                                                <!-- <div class="card-header">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12"  style="background-color: transparent;opacity:0.8;color:#000000;text-transform: bold;; text-align:center;border-width:0px;border-style:double;border-color:#417081;border-radius:20px ">
                                                    ...
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  
                                                        <div  class="col-lg-5 col-md-5 col-sm-6"  style="background-image: linear-gradient(60deg,#4e7cbe,#4e7cbe);opacity:0.8; text-align:center;color:#000000;text-transform: bold; text-shadow: 10px 10px 10px rgb(0 0 0 / 20%);box-shadow: 10px 10px 10px rgb(0 0 0 / 10%);border-width:0px;border-style:double;border-color:#417081;border-radius:20px ">
                                                                <br>
                                                                
                                                                <h1  style="color:#FFFFFF;"> <center>@lang('signup.for_algerians')<center></h1>
                                                    ...
                                                    &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp;  
                                                        <div class="col-lg-5 col-md-5 col-sm-6"  style="background-image: linear-gradient(60deg,#4e7cbe,#4e7cbe);opacity:0.8; text-align:center;color:#000000;text-transform: bold; text-shadow: 10px 10px 10px rgb(0 0 0 / 20%);box-shadow: 10px 10px 10px rgb(0 0 0 / 10%);border-width:0px;border-style:double;border-color:  #c0616a;border-radius:20px ">
                                                                <br>
                                                            <h1  style="color:#FFFFFF;"><center>@lang('signup.for_foreigners')</center></h1>
                                                                    <hr>
                                                                <h1 class="title main-heading mb-3" style="color:#FFFFFF">
