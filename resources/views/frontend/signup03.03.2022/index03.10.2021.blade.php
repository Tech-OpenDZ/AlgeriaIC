                                ...
                                <div class="col-md-3 col-lg-3 col-sm-6 mt-3">
                                  <a href="#subscription_next_button_main">
                                    ...
                                    <div class="subscription-box{{$classVal}} {{$loop->first ? 'planselected' : ''}}" id="subscription-box-{{$subscription->id}}">
                                        <h4 class="main-heading box-heading mb-2" style="text-align:center">{{$subscription->localeAll[0]->name}}</h4> 
                                        <p class="plan-detail pb-2">{{ number_format($subscription->price_dzd, 2) }} @lang('signup.dzd'){{'/'.__('signup.year').''}}</p>
