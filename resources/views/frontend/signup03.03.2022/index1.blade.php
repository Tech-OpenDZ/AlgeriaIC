            ...
            <div id="msform">
                ...
                <fieldset>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-6 mt-3">
                                    ...
                                    <div class="subscription-box{{$classVal}} {{$loop->first ? 'planselected' : ''}}" id="subscription-box-{{$subscription->id}}">
									   ...
									   <label class="plan-select ? 'choose' : ''}}" id="choose-button-subscription-box-{{$subscription->id}}">
									   @lang('signup.chooseButton')</label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 offset-lg-3 offset-sm-0">
                                            <ul class="privacy-policy-grid__elements">
                                                ...
                                                <li class="mt-3"><a target="_blank" href="{{ route('terms-of-service')}}" class="pricay-btn">@lang('signup.legalNotices')</a></li>
                                                <li class="mt-3"><a target="_blank" href="{{ route('legal-notice') }}" class="pricay-btn">@lang('signup.termsOfServices') </a></li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-3">
				   ...
				   <button type="button" id="subscription_next_button" class="register register-button action-button">@lang('signup.nextButton') </button>
                    <button type="button" id="subscription_next_button_main" class="register register-button next action-button next-button" style="display:none">
					@lang('signup.nextButton') </button>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 offset-lg-3 offset-sm-0">
                                                <ul class="privacy-policy-grid__elements">
                                                    ...
                                                    <li><a target="_blank" href="{{ route('terms-of-service')}}" class="pricay-btn">@lang('signup.legalNotices')</a></li>
                                                    <li><a target="_blank" href="{{ route('legal-notice') }}" class="pricay-btn">@lang('signup.termsOfServices') </a></li>
                                                </ul>
                                            </div>
                                            <div class="col-lg-3">
