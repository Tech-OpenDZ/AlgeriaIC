...
$query = $pdo->prepare("
        INSERT INTO stats_visites (ip , date_visite , pages_vues , pays) VALUES (:ip , :date , 1 , :pays)
...
<div id="algeria-main-section" style="position:absolute;z-index: 9;background-color:rgba(255,255,255,-0.7);left:0; right:0; linear-gradient(0.25turn, #f0f0f0, #ffffff, #ffffff, #ffffff, #f0f0f0); background-image:linear-gradient(180deg, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.01)); ">
        ...
        <tr>
            ...
            <td  style="text-align:right" style="background-color:#000000">
                <font style="font-size:12px;color:#FFFFFF">
                    <a  class="home_link" style="font-size:12px;color:#ffffff" href="/discover-algeria/about-algeria">@lang('navbar.discoverAlgeria')  |</a>
                    ...
                    <div class="dropdown-menu" id="dr-al" aria-labelledby="discover-al" style="font-size:12px;color:#777a7c;float:right;background-color:#ffffff!important;opacity:0.9" >
                        <a class="dropdown-item" style="font-size:12px;color:#66788a;font-weight:bold" href="{{ route('about')}}"> @lang('navbar.discover')</a>
                        <a class="dropdown-item" style="font-size:12px;color:#66788a;font-weight:bold" href="{{ route('qhse')}}"> QHSE</a>
                    </div>
                ...
                <!-- <a style="font-size:12px;color:#777a7c" href="{{ route('about')}}">@lang('navbar.discover') | </a>  -->

                <!--      <a style="font-size:12px;color:#777a7c" href="{{ route('sitemap')}}">@lang('navbar.sitemap') | </a> -->

                    <a class="presse_link" style="font-size:12px;color:#ffffff" href="{{ route('videos_press')}}">@lang('navbar.presse') | </a>

                    <a class="contact_link" style="font-size:12px;color:#ffffff" href="{{route('contactus')}}">@lang('navbar.contact') &nbsp; </a>
                </font>
                                            ...
                                            <tr class="headerright">
                                                ...
                                                <td class="d-none d-lg-block">
                                                    ...
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" style="background-color:#ffffff" aria-labelledby="dropdownMenuLink">
                                                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                                <a class="dropdown-item" rel="alternate" style="background-color:#ffffff;color:#66788a;font-weight:700;opacity:0.8" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                                                    {{ $properties['name'] }}
                                                                </a>
                                                            @endforeach
                                                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 p-0">
                    ...
                    <div class="logo3 d-block d-lg-none">
                        ...
                        <button class="btn-link aside-btn" style="float:right;width:50px;height:50px;background-color:transparent;border-color:transparent" ><i class="fa fa-bars" style="color:#ffffff;font-size:25px"></i></button>
                        ...
                        @if(!Auth::guard('customer')->check())
                                                ...
                                                @if($resource_menu != null)
                                                    @if(!$resource_menu->isEmpty())
                                                        ...
                                                        <p class="text-uppercase font-weight-bold text-center d-flex"> <a style='    font-size: 0.8rem;font-weight: 700;color: #222;' class='bus_univ dropdown-item' href="{{route('business-environment',['key'=>$resource->page_key])}}">{{ $resource->localeAll[0]->title }}</a></p>
                                                            <ul class="dropdown-list" style="background-color: #ffffff!important;">
                                                                 @foreach($resource->subPages as $content)
                                                                     <li><a style='color: #777;display: block; font-size: 0.85rem;line-height: 1.20;padding: 5px 12px 5px;' class='bus_univ dropdown-item' href="{{route('business-environment',['key'=>$resource->page_key])}}">{{ str_limit(html_entity_decode(strip_tags($content->localeAll[2]->title)),40,'...') }}</a></li>
                            ...
                            <a class="" href="{{route('business-environment')}}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="dropdown">
                                    ...
                                    <div class="row">
											...
											<div class="col-md-4">
												<p class="text-uppercase font-weight-bold text-center d-flex">@lang('navbar.new_opportunities')</p>
												<div id="" class="">
												...
												<div id="" class="">
                                                        ...
                                                        @foreach($business_opportunities->slice(0, 1) as $business_opportunity)
                                                            ...
                                                            <div class="" >
                                                                ...
                                                                @lang('navbar.latest_opportunity')<span class="badge bg-danger" style="color:#ffffff">New</span>
                                                                </p>
                                                                <br>
                            ...
                            <a class="" href="{{route('business-environment')}}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="dropdown">
                                    ...
                                    <div class="row">
											<div class="col-md-4">
                                            <p class="text-uppercase font-weight-bold"> @lang('navbar.new_expert_advices')</p>
											...
											<div class="col-md-4">
                                                ...
                                                @foreach($premium_news->slice(0,1) as $news)
                                                            @if(!Auth::guard('customer')->check())
                                                                            ...
                                                                            <div class="" >
                                                                                        <p class="text-uppercase font-weight-bold" >
                                                                                        @lang('navbar.latest_expert_advice') <span class="badge bg-danger" style="color:#ffffff">New</span>
                                                                                        </p>
                                                                                <br>
                                                                                        <div class="bg-image hover-overlay shadow-1-strong rounded ripple" data-mdb-ripple-color="light">
                                            ...
                                            <p class="text-uppercase font-weight-bold">@lang('home.view_more')</p>
												<ul class="dropdown-list voir_plus">
                                                    ...
                                                    <ul class="dropdown-list voir_plus">
                                                        ...
                                                        <li> <h6 style="color:#3b4855;"> <a   href="#" style="font-size:16px" data-toggle="modal"  data-target="#last_int">  <i class="fa fa-angle-right" aria-hidden="true" style="font-weight:bold"></i> @lang('navbar.last_interview')   <span class="badge bg-danger" style="color:#ffffff">New</span> </a> </h6> </li>
                                                        <li> <h6 style="color:#3b4855;"> <a style="font-size:16px"  href="{{route('videos_press')}}"> <i class="fa fa-angle-right" aria-hidden="true" style="font-weight:bold"></i> @lang('navbar.all_interviews') </a> </h6> </li>
                                                        @foreach($press_home->slice(0,1) as $data)
                                                                ...
                                                                <div class="modal-dialog" style="bacground-color: #f0f0f0">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="padding:0; margin:0">
                                                                            <iframe src="https://www.youtube.com/embed/<?php echo $data->img_link ?>" allowfullscreen="" frameborder="0" height="315" width="100%"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <a class="" href="{{route('business-environment')}}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="dropdown">
                                    ...
                                    <div class="row">
											<div class="col-md-4">
												<p class="text-uppercase font-weight-bold">@lang('navbar.new_news')</p>
