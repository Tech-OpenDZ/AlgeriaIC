                                            ...
                                            <div class="reso_disc_right col-lg-9 col-md-9 col-sm-12">
                                                ...
                                                <div class="tab-content tabs-right mt-2">
                                                    <div class="tab-content" id="v-pills-tabContent">
                                                        <div class="tab-pane fade show active" id="creation-of-company" role="tabpanel" aria-labelledby="creation-of-company-tab" style="box-shadow: 0px 10px 60px 0px rgb(0 0 0 / 10%)">
                                                                        ...
                                                                        <div class="card"
                                                                            ...
                                                                            <div class="box-hover-effect tm-sc-video-popup tm-sc-video-popup-button-over-image mb-30">
                                                                               <div class="effect-wrapper">
                                                                                <div class="thumb">
                                                                                <img class="img-fullwidth box-hover-effect" style="width:100%" src="{{asset('storage/uploads/resource/image/'.$menu->logo)}}"> 
                                                                            ...
                                                                            <div class="card-body">
                                                                                    <!-- <iframe id="iframe-{{$menu->id}}" srcdoc="<html><head><style>p, p span{font-size: 18px !important;color: #445460 !important;line-height: 1.5 !important;text-align: justify;font-weight: 300;font-family: Poppins, Helvetica, sans-serif !important;}</style></head><body>{{ $menu->localeAll[0]->description }}</body></html>" frameborder="0" scrolling="no" style="width: 100%"></iframe> -->
                                                                                        <p class="card-content" style="font-family: Poppins, Helvetica, sans-serif !important;">{!!$menu->localeAll[0]->description!!}</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
