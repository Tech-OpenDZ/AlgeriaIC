    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="mine-news d-flex justify-content-between align-items-center breaking-news " >
                <div class="d-flex flex-row flex-grow-1 flex-fill justify-content-center  py-2  px-1 news" style="background-color:#f5f5f5">
                    <span class="d-flex align-items-center"></span></div>
                <div id="ticker-roll" class="ticker  hidden-sm hidden-xs ">
                    <div class="header-flash__title d-sm-block">
...
<div id="div-content">
	...
	box-shadow: rgba(17, 17, 26, 0.1) 0px 4px 16px, rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 56px;padding-bottom: 56px;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="background-color:#f8b535;border-radius:20px;padding-top:5px">
                    ...
                    <div class="fancy-title-view1 fancy-title-view1-color">
                        <font size="3rem"><b>  M. Ismael CHIKHOUNE </b></font> <br>
                        ...
                        <iframe width="90%" height="50%" src="https://www.youtube.com/embed/3EZ0STFMxsE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>  </iframe>                    <br>
                        <br>
                        <br>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <iframe class="video-player d-block w-100" width="100%" data-video-id="DyJRvC2fnw4" height="100%" src="https://www.youtube.com/embed/DyJRvC2fnw4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>

                            <div class="carousel-item">
                                <iframe class="video-player d-block w-100" width="100%" data-video-id="B9K9Ux2yZCE" height="100%" src="https://www.youtube.com/embed/B9K9Ux2yZCE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
