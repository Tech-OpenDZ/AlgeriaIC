                            ...
                            <a class="" href="{{route('business-environment')}}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
								...
								<div class="dropdown">
                                    ...
                                    <div class="row">
											...
											<div class="col-md-4">
												<h4 class="dropdown-heading">Dernières opportunités</h4>
												<div id="" class="">
											...
											<div class="col-md-4">
												<h4 class="dropdown-heading">Dernière opportunité</h4>
												<div id="" class="">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-3 col-md-4 col-sm-4 p-0">
                                                                                <div class="news-post__left">
                                                                                    <div class="ratio-1x1" >
                                                                                        <div class="ratio-inner">
                                                                                            <img src="{{asset('storage/uploads/business_opportunity/'.$business_opportunity->id.'/logo/'.$business_opportunity->logo)}}"alt="eco-news" class="last img-fluid eco-news-img"  > 
                                                                                        </div> 
                                                                                        <div class="premium-news"></div>
                                                                                    </div>
											...
											<div class="col-md-4">
												...
												<ul class="dropdown-list voir_plus">
													<li> <a class="lien" href="{{route('business-opportunity')}}">@lang('business_opportunity.breadcrumb_check_business_opportunities')</a> </li>
                                                    <li>  <a class="lien" href="/add-business-opportunity">@lang('business_opportunity.breadcrumb_add_business_opportunities')</a></li>
								...
								<div class="dropdown">
                                    ...
                                    <div class="row">
                                                        ...
                                                        @foreach($premium_news->slice(0,3) as $news)
                                                            @if(!Auth::guard('customer')->check())
                                                                <div class="co-md-12 col-lg-12 mt-4 "  onclick="pageRedirect('{{route('premium-news_free-detail', [$news->page_key])}}')">
                                                                    <div class="news-post box" style="background-color:#ffffff">
                                                                        <div class="container">
                                                                            <div class="row">
                                                                                    ...
                                                                                    <div class="news-post__right">
                                                                                        <ul class="tags-top">
                                                                                            @foreach($news->sectors as $sector)
                                                                                                @break($loop->iteration == 2)
                                                                                                <li>
                                                                                                    <a style="" href="{{url('news').'?page=1&keyword=&sector%5B%5D='.$sector->id}}" class="yellow-box">{{$sector->localeAll[0]->name}}</a>
                                                                                                    <hr>
                                                                                        ...
                                                                                        <p class="news-text text-limit" style="font-size:13px">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-9 col-sm-10">
                                                                                    <div class="news-post__right">
                                                                                        ...
                                                                                        <p class="news-text text-limit" style='font-size:15px'>
                                                                                            {{$news->localeAll[0]->title}}
											...
											<div class="col-md-4">
												<h4 class="dropdown-heading">Voir Plus</h4>
												<ul class="dropdown-list voir_plus">
                                               <li> <a class="lien" href="{{route('premium-news-list')}}">@lang('navbar.consult_expert_advice')</a> </li>
                                               <li> <a class="lien" href="{{route('add-premium-news')}}">@lang('navbar.propose_contribution')</a>  </li>
								...
								<div class="dropdown">
                                    ...
                                    <div class="row">
											<div class="col-md-4">
                                                ...
                                                @if(!$news->isEmpty())
                                                            @foreach($news as $news)
                                                                <div class="col-md-12 col-lg-12 mt-4 "  onclick="pageRedirect('{{route('news-detail', [$news->page_key])}}')">
											...
											<div class="col-md-4">
												<h4 class="dropdown-heading">Voir Plus</h4>
												<ul class="dropdown-list voir_plus">
                                               <li> <a class="lien" href="{{route('news-list')}}">@lang('navbar.news1')</a> </li>
                                               <li> <a class="lien" href="{{route('event-list')}}">@lang('navbar.events')</a>  </li>
