...
<br>
	<center> <button type="submit" value="subscribe" class="genric-btn success radius btn-lg" style="color: #fff;border: 1px solid transparent;">@lang('inquiry.send_message')</button> </center>
