	...
	<form class="search-header-form" method="get" action="{{route('search')}}">
                    ...
                    <input class="headerserchbar" type="text" style="width: 310px" name="Search" placeholder="@lang('navbar.search_placeholder')" id="search-box" name="search" style="background-color:#000000;border-color:black">
								...
								<img src="{{asset('css/images/search.svg')}}" class="img-fluid">&nbsp&nbsp
                                              ...
                                              <td>
                                                 <ul>
                                                    <li><a href="#" class="login-in genric-btn success-border radius"  style="background-color:#4e7cbe!important" data-toggle="modal" data-target=".bd-example-modal-lg" style="cursor: pointer" id="loign_formshow" class="genric-btn success-border radius"><i class="fa fa-user"></i> @lang('navbar.toLoginIn')</a>
									   ...
									   <td class="d-none d-lg-block">
                                              ...
                                              <div class="dropdown show">
													...
													<img src="{{ asset('css/images/web-icon2.png')}}" alt="search" class="img-fluid globe"></a>
               ...
               <!-- Main-menu -->
                     ...
                     <script>
                         ...
                         <ul class="icons_head" style="float:left;left:50px">
                             ...
                             <li class="" style="">
                                 <button type="submit" color="#ffffff" style="background-color: transparent; border: none" data-toggle="modal" data-target="#mod_search" style="width:22px;height:22px">&nbsp
                        ...
                        <ul id="navigation" style = "float:right">
                           <!-- <li class="nav-item dropdown ">
                              ...
                              <div class="dropdown-menu" id="dr-al" aria-labelledby="discover-al" style="bacground-color:#FFFFFF">
                               ...
                               <div class="modal fade" id="mod_search" tabindex="-1" role="dialog" aria-labelledby="mod_search" aria-hidden="true" style="padding-top:113px;margin-left:64px">
                                   <div class="modal-dialog modal-md" role="document">
                                       <div class="modal-content" style="width:380px;height:105px">
                                           <div class="modal-header" style="text-align:center;height:50px!important">

                                               <center> <h6 class="modal-title" id="mod_search" style="text-align:center"> <p class="sub-heading-two">Rechercher </p> </h6> </center>
