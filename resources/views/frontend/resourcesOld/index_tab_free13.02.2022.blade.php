...
@section('content')
    ...
    <section class="discover-algeria">
        <div class="container" style="padding-top:15px">
            <div class="row col-md-13 col-lg-13 col-sm-13"
                 style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                <div class="envir_heading col-md-12" style="height:180px; width:100%">
                    <div class="section_title" style="padding-top:80px">
                        <h4 class="subtitle mb-1"
                            style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">
                            {{$resource->localeAll[0]->title}} </h4>
            ...
            <div class="row"
                 style=" margin-right:0px;margin-left:0px; background-color:#f5f5f5;box-shadow: 0px 0px 10px #C8C7D9;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%);border:0px solid black">
                                                ...
                                                <div class="tab-content tabs-right mt-2">
                                                    <div class="tab-content" id="v-pills-tabContent">
                                                        <div class="tab-pane fade show active" id="creation-of-company"
                                                             role="tabpanel" aria-labelledby="creation-of-company-tab">
                                                                            ...
                                                                            <!-- <div id="{{preg_replace('/[^a-zA-Z0-9. ]/', '',str_replace(' ','_',$menu->localeAll[0]->title)) }}-tab" class="collapse{{$loop->first ? ' show':''}}" aria-labelledby="{{preg_replace('/[^a-zA-Z0-9. ]/', '',str_replace(' ','_',$menu->localeAll[0]->title)) }}" data-parent="#{{preg_replace('/[^a-zA-Z0-9. ]/', '',str_replace(' ','_',$menu->localeAll[0]->title)) }}-accordionExample"> -->
                                                                                <div class="card-body">
                                                                                    <!-- <iframe id="iframe-{{$menu->id}}" srcdoc="<html><head><style>p, p span{font-size: 18px !important;color: #445460 !important;line-height: 1.5 !important;text-align: justify;font-weight: 300;font-family: Poppins, Helvetica, sans-serif !important;}</style></head><body>{{ $menu->localeAll[0]->description }}</body></html>" frameborder="0" scrolling="no" style="width: 100%"></iframe> -->
                                                                                        <p class="card-content">{!!str_limit(html_entity_decode(strip_tags($menu->localeAll[0]->description)),250,'...')!!}  
