		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="section_title text-center">
						<h2>@lang('our_services.assistance_services')</h2>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 mt-4">
					...
					<div class="single_service" style="background-color: #FFFFFF">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="{{ route('contactus-store')}}" id="" method="post" role="form" name="">
											...
											<center> <button type="submit" value="subscribe" class="common-button mt-4" onclick="myFunction()">@lang('inquiry.send_message')</button> </center>
