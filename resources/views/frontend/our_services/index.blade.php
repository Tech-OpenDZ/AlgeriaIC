							...
							@if(count($assistance_services)>0)
								@foreach($assistance_services as $services_data)
									...
									@endphp
										...
										<a href="#" class="link-info" data-toggle="modal" data-target="#modal0{{$i}}"><div class="service" style="text-align:center">
											<div class="icon" style="width:300px;">
													...
													<br>
													<h5 style="font-weight:bold">{{$services_data->localeAll[0]->title}}</h5>
													<br>
													<p class="service_description">
														{{$services_data->localeAll[0]->description}}
													</p>
										    </div> 
										</a>
