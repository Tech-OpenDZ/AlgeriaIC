        ...
        <div class="discover-algeria">
            <div class="container" style="padding-top:15px">
                <div class="row col-md-13 col-lg-13 col-sm-13" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    <div class="event_heading col-md-12" style="height:400px; width:100%;;padding-top:70px">
                        <div class="section_title" style="padding-top:125px">
                            <h2 class="subtitle align-content-center justify-content-center" style="color:#FFFFFF;font-weight:bold">@lang('event.canceled_event')</h2>
                        </div>
                                    ...
                                    <div class="title-headings">
                                        <div class="row align-items-center">
                                           <!-- <div class="col-lg-12 col-md-12 col-sm-12">
                                                <h4 class="main-heading">Évènements annulés </h4>
                                            </div>-->
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-6 mt-4">
                                                <div class="events-home__elements-box green-border-bottom">
                                                    <div class="row">
                                                      ...
                                                      <!--  <div class="event_canc">Annulé</div> -->
                                                        <style>
