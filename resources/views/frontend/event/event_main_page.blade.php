          ...
          <div class="page-content" >
             <div class="container" style="max-width:1170px;background-color:transparent">
                <div class="row" style="padding-top: 80px;padding-bottom:80px;">
                    ...
                    <div class="div_event col-md-12 col-lg-12 col-sm-12">
                                        ...
                                        @foreach($encoursList as $key => $data)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="controls" style="text-align:center;margin-right: 20px;">
                                                    <br>
                                                    <a href="{{route('past-event-detail', [$data->page_key])}}" class="news-card__read-more" style="Background-color:#ffffff;color:#000000"> @lang('home.view_more') ➞</a>
                                                </div>
                                                <br>
                                                </div> 
                                            </div> 
