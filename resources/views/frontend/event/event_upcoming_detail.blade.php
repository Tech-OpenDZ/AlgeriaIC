                ...
                <div class="row" style="background-color:#ffffff;margin-left:-15px;margin-right:-15px">
                    <div class="event_heading" style="height:400px; width:100%;padding-top:70px">
                        <div class="section_title" style="padding-top:125px">
                            <h2 class="subtitle align-content-center justify-content-center" style="color:#FFFFFF;font-weight:bold;">@lang('upcoming_event_detail.events')</h2>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="discover-algeria__left">
                            ...
                            @include('frontend.common.top_banner')
                                <br>
                            <section class="algeria-awards algeria-awards-m0 mt-4" style="box-shadow: rgb(0 0 0 / 10%) 0px 10px 60px 0px!important;">
                                ...
                                <div class="business-banner mt-4" style="box-shadow: rgb(0 0 0 / 10%) 0px 10px 60px 0px!important;" >
