...
@section('head')
    ...
    <title>{{str_limit($upcomingEvent->localeAll[0]->title,50,'...')}} | @lang('news.placeName')</title>
...
@section('content')
    <section class="news-main-area">
        <div class="discover-algeria">
            <div class="container" style="padding-top:15px">
                <div class="row col-md-13 col-lg-13 col-sm-13" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    <div class="event_heading col-md-12" style="height:180px; width:100%">
                        <div class="section_title" style="padding-top:80px">
                            <h4 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">@lang('upcoming_event_detail.events')</h4>
                ...
                <div class="row" style=" margin-right:0px;margin-left:0px; background-color:#f5f5f5;box-shadow: 0px 0px 10px #C8C7D9;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%);border:0px solid black">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="discover-algeria__left">
                            <!--<ol class="breadcrumb-area">
                                <li class="breadcrumb-elements"><a href="#">@lang('upcoming_event_detail.home')</a></li>
                                <li class="active">@lang('upcoming_event_detail.events')</li>
                            </ol> -->
                            @include('frontend.common.top_banner')
                                <br>
                            <section class="algeria-awards algeria-awards-m0 mt-4">
                                <div class="awards-area">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 col-sm-3 awards-area__left">
                                            <div class="ratio-1x1">
                                                <div class="ratio-inner">
                                                    <img src="{{asset('storage/uploads/event_logos/'.$upcomingEvent->event_logo)}}" alt="awards" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-9 col-md-8 col-sm-10 awards-area__right">
                                            <div class="awards-content">
                                                <h1 class="main-heading">{{$upcomingEvent->localeAll[0]->title}}</h1>
                                                <p class="awards-date"> @lang('home.from') {{Carbon\Carbon::parse($upcomingEvent->start_date)->isoFormat('LL')}} @lang('home.to') {{Carbon\Carbon::parse($upcomingEvent->end_date)->isoFormat('LL')}}  | {{ $upcomingEvent->localeAll[0]->place }}</p>
                                ...
                                <div class="business-banner mt-4">
                                    <a href="#"><img src="{{ asset('storage/uploads/banner/'.$banner[0]->bannerImages[0]->banner_img)}}" alt="event-banner" class="img-fluid"></a>
                                </div>
                                @endif
                                <div class="awards-article mt-2">
                                    <h6 class="sub-heading mb-4 mt-4"></h6>
                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.presentationEvent')</p>

                                    <div class="awards-heading-caption">
                                    {!! str_replace('<p>&nbsp;</p>', "<br>", $upcomingEvent->localeAll[0]->description) !!}

                                    {!! str_replace('<p>&nbsp;</p>', "<br>", $upcomingEvent->localeAll[0]->event_summary) !!}
                                    </div>
                                    <p class="awards-heading mt-4 mb-2">@lang('upcoming_event_detail.sector')</p>
                                    <p class="awards-heading-caption mb-4">
                                        @php
                                            $separator = '';
                                        @endphp
                                        @foreach($upcomingEvent->sectors as $sector)
                                            {{$separator.$sector->localeAll[0]->name}}
                                            @php
                                                $separator = ', ';
                                            @endphp
                                        @endforeach
                                    ...
                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.locationEvent')</p>
                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->localeAll[0]->place}} </p>
                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.priceSquareMeter')</p>
                                    <p class="awards-heading-caption">{{$upcomingEvent->price_per_square_meter}}  DZD</p>

                                    @if(!$upcomingEvent->eventImage->isEmpty())
                                    <div class="invest-business-network">
                                        <div class="investment-post mb-3">

                                            <div class="row">
                                                @foreach($upcomingEvent->eventImage as $image)
                                                <div class="col-lg-3 col-md-6 col-sm-3">
                                                    <div class="investment-posts mt-4">
                                                        <div class="ratio-1x1">
                                                            <div class="ratio-inner">
                                                                <img src="{{ asset('storage/uploads/event_images/'.$image->image) }}" alt="investment-post-one" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane-socialmedia">
                                        <ul>
                                            <p class="sharing">@lang('upcoming_event_detail.sharing')</p>
                                            @include('frontend.share')
                                        </ul>
                                    </div>
                                </div>
                            </section>
                            <section class="algeria-awards  mt-4">
                                <div class="awards-article">
                                    <h6 class="sub-heading mb-4">@lang('upcoming_event_detail.organizerContact')</h6>
                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.agency')</p>
                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->localeAll[0]->organizer_agency}}</p>
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        <div class="organizer-contact">
                                            <div class="row">
                                                <div class="col-md-4 col-lg-4 col-sm-4 no-padding-left">
                                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.phone')</p>
                                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->organizer_telephone}}</p>
                                                </div>
                                                <div class="col-md-4 col-lg-4 col-sm-4 no-padding-left">
                                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.cellPhone')</p>
                                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->organizer_mobile}}</p>
                                                </div>
                                                <div class="col-md-4 col-lg-4 col-sm-4 no-padding-left">
                                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.fax')</p>
                                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->organizer_fax}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        <div class="organizer-contact">
                                            <div class="row">
                                                <div class="col-md-4 col-lg-4 col-sm-4 no-padding-left">
                                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.organizer_name')</p>
                                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->organizer_contact}}</p>
                                                </div>
                                                <div class="col-md-4 col-lg-4 col-sm-4 no-padding-left">
                                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.organizer_job_title')</p>
                                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->localeAll[0]->organizer_job_title}}</p>
                                                </div>
                                    ...
                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.email')</p>
                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->organizer_email}}</p>
                                
                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.website')</p>
                                    <p class="awards-heading-caption mb-4">{{$upcomingEvent->organizer_website}}</p>
                                    <p class="awards-heading mb-2">@lang('upcoming_event_detail.address')</p>
                                    <p class="awards-heading-caption mb-4">{{ html_entity_decode(strip_tags($upcomingEvent->localeAll[0]->organizer_address)) }} </p>
                                    
                                    <div class="participation-file mb-2">
                                    <div class="row">
                                        @foreach($upcomingEvent->document as $document) 
                                            ...
                                            @if($document->document_type == 'participation_file')
                                                ...
                                                @endphp
                                                @if(Config::get('app.locale') == 'en' && $doc->en != '')
                                                <div class="col-md-12 col-lg-12">
                                                    <a href="{{ asset('storage/uploads/event_documents/'.$doc->en)}}" class="common-button" download>@lang('upcoming_event_detail.participationFileDownload')</a>
                                                </div>
                                                @endif
                                                @if(Config::get('app.locale') == 'fr' && $doc->fr  != '')
                                                <div class="col-md-12 col-lg-12">
                                                    <a href="{{ asset('storage/uploads/event_documents/'.$doc->fr)}}" class="common-button" download>@lang('upcoming_event_detail.participationFileDownload')</a>
                                                </div>
                                                @endif 
                                            @endif
                                        ...
                                        @endforeach
                                        @if(!$upcomingEvent->eventExhibitor->isEmpty())
                                        <div class="col-md-12 col-lg-12">
                                            <div class="tab-pane-socialmedia">
                                                <ul>
                                                    <p class="sharing">@lang('upcoming_event_detail.sharing')</p>
                                                    <li class="">
                                                        <div data-network="facebook" class="st-custom-button circle-fb">
                                                            <a href="#fb"><img src="{{asset('css/images/fb.svg')}}"></a>
                                                        </div>
                                                    </li>
                                                    <li class="">
                                                        <div data-network="email" class="st-custom-button circle-mail">
                                                            <a href="#email"><img src="{{asset('css/images/mail.svg')}}"></a>
                                                        </div>
                                                    </li>
                                                    <li class="">
                                                        <div data-network="messenger" class="st-custom-button circle-msg">
                                                            <a href="#mess"><img src="{{asset('css/images/messenger.svg')}}"></a>
                                                        </div>
                                                    </li>
                                                    <li class="circle-send">
                                                        <a href="javascript:void(0);" data-link="{{route('upcoming-event-detail', [$upcomingEvent->page_key])}}" class="copy_link"><img src="{{asset('css/images/send.svg')}}"></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    {{-- <div class="col-lg-3 col-md-3">
                        ...
                        <div class="discover-algeria__right">
                             ...
                             @endif
                                <div class="join-algeria join-algeriaN doc-green">
                                    <div class="row">
                ...
                <!-- row ends here -->
                @if(!$upcomingEvent->eventReference->isEmpty())
                <!-- References starts here -->
                <section class="brand-carousel">
                    <h4 class="sub-heading mb-3">@lang('upcoming_event_detail.references')</h4>
                    <div class="our-partners owl-carousel owl-theme brand-slider active" id="brands-demo">
                        @foreach($upcomingEvent->eventReference as $reference)
                        <div class="brand-outer-area item">
                            <img src="{{ asset('storage/uploads/event_references/'.$reference->image) }}" alt="logo1" class="img-fluid">
                        </div>
                        @endforeach
                    </div>
                </section>
    ...
    @if(!$eventsInSameSector->isEmpty())
    <!-- event in same sector starts here -->
    <section class="events-same-sector">
        <section class="brand-carousel partners-brand">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="partners event-partners">
                            <h4 class="sub-heading mb-3">@lang('upcoming_event_detail.eventSameSector')</h4>
                            <a class="events-prev-btn carousel-control-prev blue-slide" href="#brand" data-slide="prev">
                                <span class="carousel-control-prev-icon partners-prev"></span>
                            </a>
                            <a class="events-next-btn carousel-control-next blue-slide" href="#brand" data-slide="next">
                                <span class="carousel-control-next-icon partners-next"></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12">
                        <div class="upcoming-events-slider owl-carousel owl-theme brand-slider active" id="brands-demo">
                            @foreach($eventsInSameSector as $event)
                            <div class="item">
                                <?php
                                ...
                                <a href="{{route($route,[$event->page_key])}}">
                                    <div class="ratio-1x1">
                                        <div class="ratio-inner">
                                           <img src="{{asset('storage/uploads/event_logos/'.$event->event_logo)}}" alt="eventsinsector" class="img-fluid">
                                        </div>
                                    </div>
                                </a>
                            </div>
