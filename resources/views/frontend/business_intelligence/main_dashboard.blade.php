                            ...
                            <div class="dashboard-section">
                                ...
                                <div id="latestnewscarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                                    <div class="carousel-inner">
                                        @foreach($main_dashboard as $dashboard)
                             ...
                             <div class="resources-invest-algeria__area">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-4">
                                        <div class="resource-algeria-box min-height border-green">
                                           <h6 class="sub-heading">@lang('business_intelligence.sector_reports')</h6> 
                                           <p class="resource-caption pt-2 pb-2">@lang('business_intelligence.sector_report_content') </p>
                                            @if($customer_id != null)
                                            <a href="{{ route('business-intelligence-subdashboard',['key'=>'sector-reports']) }}" class="download-link">@lang('business_intelligence.download_link')</a>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-4">
                                        <div class="resource-algeria-box min-height border-yellow">
                                           <h6 class="sub-heading">@lang('business_intelligence.pr_monitoring')</h6> 
                                           <p class="resource-caption pt-2 pb-2">@lang('business_intelligence.pr_monitoring_report_content')</p>
                                           @if($customer_id != null)
                                           <a href="{{ route('business-intelligence-subdashboard',['key'=>'pr-monitoring']) }}" class="download-link">@lang('business_intelligence.download_link')</a>
                                           @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-4">
                                        <div class="resource-algeria-box min-height border-red">
                                           <h6 class="sub-heading">@lang('business_intelligence.e_reputation')</h6> 
                                           <p class="resource-caption pt-2 pb-2">@lang('business_intelligence.e_reputation_report_content')</p>
                                           @if($customer_id != null)
                                           <a href="{{ route('business-intelligence-subdashboard',['key'=>'e-reputation']) }}" class="download-link">@lang('business_intelligence.download_link')</a>
                                           @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-4">
                                        <div class="resource-algeria-box min-height border-blue">
                                           <h6 class="sub-heading">@lang('business_intelligence.competitive_intelligence')</h6> 
                                           <p class="resource-caption pt-2 pb-2">@lang('business_intelligence.competitive_intelligence_report_content')</p>
                                           @if($customer_id != null)
                                           <a href="{{ route('business-intelligence-subdashboard',['key'=>'competitive-intelligence']) }}" class="download-link">@lang('business_intelligence.download_link')</a>
                                           @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-4">
                                        <div class="resource-algeria-box min-height border-yellow">
                                           ...
                                           <p class="resource-caption pt-2 pb-2">@lang('business_intelligence.legal_monitoring_report_content')</p>
                                           @if($customer_id != null)
                                           <a href="{{ route('business-intelligence-subdashboard',['key'=>'legal-monitoring'])}}" class="download-link">@lang('business_intelligence.download_link')</a>
                                           @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-4">
                                        <div class="resource-algeria-box min-height border-green">
                                           ...
                                           <p class="resource-caption pt-2 pb-2">@lang('business_intelligence.events_report_content')</p>
                                           @if($customer_id != null)
                                           <a href="{{ route('business-intelligence-subdashboard',['key'=>'events'])}}" class="download-link">@lang('business_intelligence.download_link')</a>
                                           @endif
                                        </div>
                                    </div>   
                                </div>
