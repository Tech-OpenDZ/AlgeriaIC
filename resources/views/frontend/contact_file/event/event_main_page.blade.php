...
@section('head')
    ...
    <title>@lang('event.events') | @lang('news.placeName')</title>
...
@section('content')
        ...
        <div class="discover-algeria">
            <div class="container" style="padding-top:15px">
                <div class="row col-md-13 col-lg-13 col-sm-13" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    <div class="event_heading col-md-12" style="height:180px; width:100%">
                        <div class="section_title" style="padding-top:80px">
                            <h4 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">@lang('event.events')</h4>
                ...
                <div class="row" style=" margin-right:0px;margin-left:0px; background-color:#f5f5f5;box-shadow: 0px 0px 10px #C8C7D9;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%);border:0px solid black" >
                    <div class="div_event col-md-9 col-lg-9 col-sm-12">
                        <div class="discover-algeria__left">
                            <ol class="breadcrumb-area">
                               <!--  <li class="breadcrumb-elements"><a href="#">@lang('event.home')</a></li> -->
                               <!-- <li class="active">@lang('event.events')</li> -->
                            </ol>
                            @include('frontend.common.top_banner')

                            <div class="slider-area news-head">
                                @include('frontend.banner.index', ['banner' => 'events'])
                            </div>
                            <!-- slider ends here -->
                                    ...
                                    <section class="search-engine">
                                        <div class="search-engine__elements">
                                            <div class="input-group mb-4">
                                                <input type="text" class="form-control" placeholder="@lang('event.keywordPlaceholder')" id="search-form" name="keyword">
                            ...
                            <section class="events-main-area mt-5">
                            ...
                            @if(!$encoursList->isEmpty())
                                ...
                                <div class="events-home">
                                    <div class="title-headings">
                                        <div class="row align-items-center">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <h4 class="main-heading">@lang('event.current_events')</h4>
                                            </div>
                                    ...
                                    <div class="events-home__elements">
                                        ...
                                        @foreach($encoursList as $key => $data)
                                            @if($key == 0 || $key%2 == 0)
                                        <div class="row">
                                            @endif
                                            <div class="col-md-6 col-lg-6 col-sm-6 mt-4">
                                                <div class="events-home__elements-box green-border-bottom box">
                                                    <div class="row">
                                                            ...
                                                            <div class="event-box-left">
                                                                <div class="ratio-1x1">
                                                                    <div class="ratio-inner">
                                                                       <a href="{{route('event-encours-detail', [$data->page_key])}}">
                                                        ...
                                                        <div class="event_current">@lang('event.ongoing') </div> 
                                                        <style>

                                                        .event_current{
    background-color: #1fa564;
    padding: 7px;
    color: #FFFFFF;
    font-size: 0.625rem;
    position: absolute;
    ...
    border-top-left-radius: 4px;
                                                        ...
                                                        <div class="col-md-8 col-lg-9 col-sm-9">
                                                            <div class="event-box-right">
                                                                ...
                                                                <a href="{{route('past-event-detail', [$data->page_key])}}">
                                                                ...
                                                                <p class="event-date text-truncate">
                                                                    @lang('home.from') {{Carbon\Carbon::parse($data->start_date)->isoFormat('LL') }} @lang('home.to') {{Carbon\Carbon::parse($data->end_date)->isoFormat('LL') }} 
                                                                </p>
                                                                <p class="event-date text-truncate">
                                            ...
                                            @if(!isset($encoursList[$key+1]) && count((array)$encoursList)%2 != 0)
                                            </div>
                                        ...
                                        <div class="title-headings">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                                                    <!-- <h4 class="main-heading">Business Opportunities</h4> -->
                                                </div>
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                                <div class="heading-with-arrow mt-3">
                                                    <a href="{{route('encours-event-list')}}" class="more-data">@lang('event.seeMore')</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @else
                                <div class="no-post-found">
                                    <p class="news-post-caption">@lang('event.noCurrentEvents')</p>
                                </div>
                                ...
                                @if((!$upcomingList->isEmpty()) || (!$postponed->isEmpty()))
                                @if((!$upcomingList->isEmpty()) || (!$postponed->isEmpty()))
                                <div class="events-home">
                                    <div class="title-headings">
                                        <div class="container">
                                            <div class="row align-items-center">
                                                <div class="col-lg-5 col-md-12 col-sm-12 no-padding-left">
                                                    <h4 class="main-heading"> @lang('event.upcomingEvents')</h4>
                                                </div>
                                               <!-- <div class="div_down col-lg-7 col-md-12 col-sm-12">
                                                    <div class="row sharing-area">
                                                        <div class="tab-pane-socialmedia d-flex pt-2">
                                                            <ul>
                                                            ...
                                                            @php
                                                                ...
                                                                if(Config::get('app.locale') == 'en') {
                                                                    if(file_exists('storage/uploads/upcoming_event/en_download.pdf')) {
                                                                        $document = asset('storage/uploads/upcoming_event/en_download.pdf');
                                                                    }

                                                                } else if(Config::get('app.locale') == 'fr') { 
                                                                    if(file_exists('storage/uploads/upcoming_event/fr_download.pdf')) {
                                                                        $document = asset('storage/uploads/upcoming_event/fr_download.pdf');
                                                                    }

                                                                } else if(Config::get('app.locale') == 'ar') {
                                                                    if(file_exists('storage/uploads/upcoming_event/ar_download.pdf')) {
                                                                        $document = asset('storage/uploads/upcoming_event/ar_download.pdf');
                                                                    }
                                                                }
                                                            @endphp
                                                            @if($document !='')
                                                            <a href="{{$document}}" download>
                                                                <div class="common-button">
                                                                    <div class="events-download-button">
                                                                        <p class="text-white download-heading">@lang('event.download')</p>
                                                                        <p class="download-events text-white" style="text-transform: initial;">@lang('event.download-text') </p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            @endif
                                                            <!-- <a href="{{route('event-upcoming-download')}}" >
                                                                <div class="common-button">
                                                                    <div class="events-download-button">
                                                                        <p class="text-white download-heading">@lang('event.download')</p>
                                                                        <p class="download-events text-white">@lang('event.allUpcomingEvents') </p>
                                                                    </div>
                                                                </div>
                                                            </a> -->
                                                       <!-- </div>
                                    ...
                                    <div class="events-home__elements">
                                        @foreach($upcomingList as $key => $data)
                                            @if($key == 0 || $key%2 == 0)
                                            <div class="row">
                                            @endif
                                                <div class="col-md-6 col-lg-6 col-sm-6 mt-4">
                                                    <div class="events-home__elements-box green-border-bottom box">
                                                        <div class="row">
                                                            ...
                                                            <div class="event_futur">@lang('event.futur') </div> 
                                                        <style>
    ...
    border-top-left-radius: 4px;
                                                            ...
                                                            <div class="col-md-8 col-lg-9 col-sm-9">
                                                                <div class="event-box-right">
                                                                    <p class="print-month">{{$data->sectors[0]->localeAll[0]->name}}</p>
                                                                    <a href="{{route('upcoming-event-detail', [$data->page_key])}}">
                                                                        <p class="semi-bold-para threelinetext" style="text-transform: none">{{ html_entity_decode(strip_tags($data->localeAll[0]->title)) }}</p>
                                                                    </a>
                                                                    <p class="event-date text-truncate">
                                                                        @lang('home.from') {{Carbon\Carbon::parse($data->start_date)->isoFormat('LL') }} @lang('home.to') {{Carbon\Carbon::parse($data->end_date)->isoFormat('LL') }} 
                                                                    </p>
                                            ...
                                            @if(!isset($upcomingList[$key+1]) && count((array)$upcomingList)%2 != 0)
                                            </div>
                                            @elseif ($key == 1 || $key%2 == 1)
                                            </div>
                                            @endif
                                        ...
                                        @foreach($postponedList as $key => $data)
                                            @if($key == 0 || $key%2 == 0)
                                        <div class="row">
                                            @endif
                                            <div class="col-md-6 col-lg-6 col-sm-6 mt-4">
                                                <div class="events-home__elements-box green-border-bottom box">
                                                    <div class="row">
                                                        ...
                                                        <div class="event_rep"><a class="post" href="#" title="@lang('event.old_program') :  @lang('home.from') {{Carbon\Carbon::parse($data->old_start_date)->isoFormat('LL') }} @lang('home.to') {{Carbon\Carbon::parse($data->old_end_date)->isoFormat('LL') }} "> @lang('event.postponed')</a></div> 
                                                        <style>
                                                            .post{
                                                                color:#FFFFFF!important;
                                                                
                                                            }
                                                            .post, .post:active, .post:focus, .post:hover {
                                                                            color: #FFFFFF!important;
                                            ...
                                            @if(!isset($postponedList[$key+1]) && count((array)$postponedList)%2 != 0)
                                            </div>
                                            @elseif ($key == 1 || $key%2 == 1)
                                            </div>
                                            @endif
                                        ...
                                        <div class="title-headings">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                                    <div class="heading-with-arrow mt-3">
                                                        <a href="{{route('upcoming-event-list')}}" class="more-data">@lang('event.seeMore')</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="events-home">
                                    <div class="title-headings">
                                        <div class="row align-items-center">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <h4 class="main-heading">@lang('event.pastEvents')</h4>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-6 mt-4">
                                                <div class="events-home__elements-box green-border-bottom box">
                                                    <div class="row">
                                                        ...
                                                        <div class="event_past">@lang('event.past')</div> 
                                                        <style>
    ...
    border-top-left-radius: 4px;
                                            ...
                                            @if(!isset($pastList[$key+1]) && count((array)$pastList)%2 != 0)
                                            </div>
                                            @elseif ($key == 1 || $key%2 == 1)
                                            </div>
                                            @endif
                                        ...
                                        <div class="title-headings">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                                <div class="heading-with-arrow mt-3">
                                                    <a href="{{route('past-event-list')}}" class="more-data">@lang('event.seeMore')</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @else
                                <div class="no-post-found">
                                    <p class="news-post-caption">@lang('event.noPastEvents')</p>
                                </div>
                            @endif
                         ...
                         <!--   @if(!$postponedList->isEmpty())
                                ...
                                <div class="events-home">
                                    <div class="title-headings">
                                        <div class="row align-items-center">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <h4 class="main-heading">Évènements reportés </h4>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-6 mt-4">
                                                <div class="events-home__elements-box green-border-bottom">
                                                    <div class="row">
                                                        ...
                                                        <div class="event_rep">Reporté</div> 
                                                        <style>
    ...
    border-top-left-radius: 4px;
                                        ...
                                        <div class="title-headings">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                                <div class="heading-with-arrow mt-3">
                                                    <a href="#" class="more-data">@lang('event.seeMore')</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @else
                               <div class="no-post-found">
                                    <p class="news-post-caption">Aucun Évènement Reporté</p>
                                </div> 
                                ...
                                <div class="events-home">
                                    <div class="title-headings">
                                        <div class="row align-items-center">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <h4 class="main-heading">@lang('event.canceled_event') </h4>
                                            </div>
                                    ...
                                    <div class="events-home__elements">
                                        ...
                                        @foreach($canceledList as $key => $data)
                                            @if($key == 0 || $key%2 == 0)
                                        <div class="row">
                                            @endif
                                            <div class="col-md-6 col-lg-6 col-sm-6 mt-4">
                                                <div class="events-home__elements-box green-border-bottom box">
                                                    <div class="row">
                                                        ...
                                                        <div class="event_canc">@lang('event.canceled')</div> 
                                                        <style>
    ...
    border-top-left-radius: 4px;
                                            ...
                                            @if(!isset($canceledList[$key+1]) && count((array)$canceledList)%2 != 0)
                                            </div>
                                            @elseif ($key == 1 || $key%2 == 1)
                                            </div>
                                            @endif
                                        ...
                                        <div class="title-headings">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                                <div class="heading-with-arrow mt-3">
                                                    <a href="{{route('canceled-event-list')}}" class="more-data">@lang('event.seeMore')</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
  ...
  box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22);
                ...
                @if(!$featuredEvents->isEmpty())
                    ...
                    <section class="brand-carousel">
                        <h4 class="main-heading mb-3">@lang('event.featuredEvents')</h4>
                        <div class="our-partners event-feature-partners owl-carousel owl-theme brand-slider active" id="brands-demo">
                            @foreach($featuredEvents as $data)
                                <div class="brand-outer-area item">
                                    <div class="ratio-1x1">
                                        <div class="ratio-inner">
                                            <a href="{{route('upcoming-event-detail', [$data->page_key])}}">
                                                <img src="{{asset('storage/uploads/event_logos/'.$data->event_logo)}}" alt="logo1" class="img-fluid">
                                            </a>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on( "click", '#search-by-kw', function(event){
                ...
                search_by_kw = $('#search-form').val();
                if( search_by_kw !== ""){
                    window.location.href = "{{route('event-list')}}?keyword="+search_by_kw+"&sector=&zone=&source=&start_date=";
                }
            });
