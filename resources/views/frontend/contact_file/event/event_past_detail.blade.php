...
@section('head')
    ...
    <title>{{str_limit($pastEvent->localeAll[0]->title,50,'...')}} | @lang('news.placeName')</title>
    ...
    <section class="news-main-area">
        <div class="discover-algeria">
            <div class="container" style="padding-top:15px">
                <div class="row col-md-13 col-lg-13 col-sm-13" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    <div class="event_heading col-md-12" style="height:180px; width:100%">
                        <div class="section_title" style="padding-top:80px">
                            <h4 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">@lang('past_event_detail.events')</h4>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="discover-algeria__left">
                            ...
                            <!--<ol class="breadcrumb-area">
                                <li class="breadcrumb-elements"><a href="#">@lang('past_event_detail.home')</a></li>
                                <li class="active">@lang('past_event_detail.events')</li>
                            </ol> -->
                           @include('frontend.common.top_banner')
                            <section class="algeria-awards mt-4">
                                <div class="awards-area">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 col-sm-2 awards-area__left">
                                            <div class="ratio-1x1">
                                                <div class="ratio-inner">
                                                    <img src="{{asset('storage/uploads/event_logos/'.$pastEvent->event_logo)}}" alt="awards" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-9 col-md-8 col-sm-10 awards-area__right">
                                            <div class="awards-content">
                                                <h1 class="main-heading">{{$pastEvent->localeAll[0]->title}}</h1>
                                                <p class="awards-date">   @lang('home.from') {{Carbon\Carbon::parse(date('F jS, Y',strtotime($pastEvent->start_date)))->isoFormat('LL')}} @lang('home.to') {{Carbon\Carbon::parse($pastEvent->end_date)->isoFormat('LL')}}
                                                 | {{ $pastEvent->localeAll[0]->place }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                @if(!$banner[0]->bannerImages->isEmpty())
                                <div class="business-banner mt-4 mb-4">
                                ...
                                <div class="awards-article">
                                    <h6 class="sub-heading mb-4"></h6>
                                    <p class="awards-heading mb-2">@lang('past_event_detail.presentationEvent')</p>

                                    <div class="awards-heading-caption">
                                    {!! str_replace('<p>&nbsp;</p>', "<br>", $pastEvent->localeAll[0]->description) !!}

                                    {!! str_replace('<p>&nbsp;</p>', "<br>", $pastEvent->localeAll[0]->event_summary) !!}
                                    </div>
                                    <p class="awards-heading mt-4 mb-2">@lang('past_event_detail.sector')</p>
                                    ...
                                    <p class="awards-heading mb-2">@lang('past_event_detail.locationEvent')</p>
                                    <p class="awards-heading-caption mb-4">{{$pastEvent->localeAll[0]->place}} </p>
                                    {{-- <p class="awards-heading mb-2">@lang('past_event_detail.priceSquareMeter')</p> --}}
                                    {{-- <p class="awards-heading-caption">{{$pastEvent->price_per_square_meter}}  DZD</p> --}}
                                    <ul>
                                    @foreach($pastEvent->document as $document) 
                                        @if($document->document_type == 'first_document' || $document->document_type == 'second_document')
                                            @php
                                            ...
                                            <p class="awards-heading mb-2" style="margin-top:20px;">@lang('business_opportunity.documents')</p>
                                            <li>
                                                <a href="{{ asset('storage/uploads/event_documents/'.$doc->en)}}" style="width: max-content;" download><i class="fa fa-download" aria-hidden="true"></i> 
                                            ...
                                            <p class="awards-heading mb-2" style="margin-top:20px;">@lang('business_opportunity.documents')</p>
                                            <li>
                                                <a href="{{ asset('storage/uploads/event_documents/'.$doc->fr)}}" style="width: max-content;" download><i class="fa fa-download" aria-hidden="true"></i> 
                                                {{ preg_replace('/[^a-zA-Z0-9. ]/', '', str_replace('_', ' ', $document_name->fr)) }}</a>
                                            </li>
                                            @endif
                                        @endif
                                    @endforeach
                                    ...
                                    @if(!$pastEvent->eventImage->isEmpty())
                                    <div class="invest-business-network">
                                        <div class="investment-post mb-3">

                                            <div class="row">
                                                @foreach($pastEvent->eventImage as $image)
                                    ...
                                    <div class="tab-pane-socialmedia">
                                        <ul>
                                            <p class="sharing">@lang('past_event_detail.sharing')</p>
                            ...
                            <section class="algeria-awards mt-4">
                                <div class="awards-article">
                                    <h6 class="sub-heading mb-4">{{$pastEvent->localeAll[0]->title}}</h6>
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        <div class="organizer-contact">
                                            <div class="row">
                                                <div class="col-md-4 col-lg-4 col-sm-4 no-padding-left">
                                                    <div class="ratio-1x1">
                                                        <div class="ratio-inner-news">
                                                            <img src="{{asset('storage/uploads/event_logos/'.$pastEvent->event_logo)}}" alt="past-events" class="img-fluid " >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-8 col-lg-8 col-sm-8 no-padding-left">
                                                    @if($pastEvent->localeAll[0]->event_summary)
                                                    <p class="awards-heading pt-2 mb-2">@lang('past_event_detail.summaryOfEvent')</p>
                                                    <p class="awards-heading-caption mb-4"> {{ str_limit(html_entity_decode(strip_tags($pastEvent->localeAll[0]->event_summary)),150,'...') }}</p>
                                                    @endif
                                                    @if(!$pastEvent->eventExhibitor->isEmpty())
                                                    <a href="{{route('past-event-exhibitor-download', [$pastEvent->id])}}" class="list-of-exhibitors mt-4">@lang('past_event_detail.listOfExhibitors') </a>
                                                    @endif
                                                </div>
                                                <!-- <div class="col-md-4 col-lg-4 col-sm-4">
                                                    <img src="images/past-event-img.svg" alt="past-events" class="img-fluid">
                                                </div> -->
                                                <!-- <div class="col-md-8 col-lg-8 col-sm-8 mb-3 no-padding-left">
                                                </div> -->
                                            </div>
                                        </div>
                                    </div>
                ...
                <!-- row ends here -->
                @if(!$pastEvent->eventReference->isEmpty())
                <!-- References starts here -->
                <section class="brand-carousel">
                    <h4 class="sub-heading mb-3">@lang('past_event_detail.references')</h4>
                    <div class="our-partners owl-carousel owl-theme brand-slider active" id="brands-demo">
                        @foreach($pastEvent->eventReference as $reference)
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="partners event-partners">
                            <h4 class="sub-heading mb-3">@lang('past_event_detail.eventSameSector')</h4>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="upcoming-events-slider owl-carousel owl-theme brand-slider active" id="brands-demo">
                            ...
                            <div class="item">
                                ...
                                ?>
                                <div class="ratio-1x1">
                                    <div class="ratio-inner-news img">
