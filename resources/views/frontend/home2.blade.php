<html lang="en">
  ...
  @include('frontend/layouts/header_home')
   <!-- Header End -->
    ...
    <div  class="d-inline-block d-md-block" style="height:850px;padding:0; margin:0;lef:0;right:0">
       <div>
           <div class="col-md-12 col-sm-12"style="position:absolute;margin-top:400px;z-index: 9;float:right;margin-left:1400px;opacity:0.5" >
               <a href="#home"> <i class="icon-arrow-outline-down"style="font-size:55px; color:#f9b634"></i></a>
           </div>
       <video
              class="my_video" controls autoplay loop
              src="{{ asset('css/front-end/home_page_styles/assets/videos/Algeria INVEST®.mp4')}}">  </video>
      ...
      <div id="home" class="tradingview-widget-container">
                        ...
                        <ul class="row">
                           <li class="col-md-4">
                              <div class="categories-view1-wrap">
                                 <i class="icon-3"></i>
                                 <a href="#">@lang('home.administrative_assistance')</a>
                                 <span>01</span>
                              </div>
                           </li>
                           <li class="col-md-4">
                              <div class="categories-view1-wrap">
                                 <i class="icon-4"></i>
                                 <a href="#">@lang('home.due_diligence')</a>
                                 <span>02</span>
                              </div>
                           </li>
                           <li class="col-md-4">
                              <div class="categories-view1-wrap">
                                 <i class="icon-12"></i>
                                 <a href="#">@lang('home.exhibition_advice_and_assistance')</a>
                                 <span>03</span>
                              </div>
                           </li>
                           <li class="col-md-4">
                              <div class="categories-view1-wrap">
                                 <i class="icon-6"></i>
                                 <a href="#">@lang('home.juridic_assistance')</a>
                                 <span>04</span>
                              </div>
                           </li>
                           <li class="col-md-4">
                              <div class="categories-view1-wrap">
                                 <i class="icon-7"></i>
                                 <a href="#">@lang('home.human_resource_management')</a>
                                 <span>05</span>
                              </div>
                           </li>
                           <li class="col-md-4">
                              <div class="categories-view1-wrap">
                                 <i class="icon-8"></i>
                                 <a href="#">@lang('home.advice_and_assistance_in_calls_for_tenders')</a>
                                 <span>06</span>
                              </div>
                           </li>
                           <li class="col-md-4">
                              <div class="categories-view1-wrap">
                                 <i class="icon-9"></i>
                                 <a href="#">@lang('home.location_and_logistics')</a>
                                 <span>07</span>
                              </div>
                           </li>
                           <li class="col-md-4">
                              <div class="categories-view1-wrap">
                                 <i class="icon-10"></i>
                                 <a href="#">@lang('home.export_assistance')</a>
                                 <span>08</span>
                              </div>
                           </li>
                              ...
                              <div class="categories-view1-wrap">
                                 <i class="icon-11"></i>
                                 <a href="#">@lang('home.representation_of_foreign_companies')</a>
                                 <span>09</span>
                              </div>
                           </li>
                              ...
                              <div class="categories-view1-wrap">
                                 <i class="icon-12"></i>
                                 <a href="#">@lang('home.penny_penny')</a>
                                 <span>10</span>
                              </div>
                           </li>
                              ...
                              <div class="categories-view1-wrap">
                                 <i class="icon-8"></i>
                                 <a href="#">@lang('home.badis_badis')</a>
                                 <span>11</span>
                              </div>
                           </li>
