...
<div class="container" style="max-width:1170px;background-color:transparent">
        @foreach($press_home->slice(0,1) as $press)
                    ...
                    <div class="col-lg-5 col-xl-5 col-sm-12">
                            <div class="about-box style2">
                                <div class=" tm-sc-video-popup tm-sc-video-popup-button-over-image mb-30">
                                            ...
                                            <div class="effect-wrapper">
                                                <div class="thumb">
                                                <img class="img-fullwidth box-hover-effect" style="width:100%" src="{{asset('storage/uploads/press/image/'.$press->press_image)}}"> 
                                            
                                               
                                                </div>
                                            </div>
                                            </div>
                                    <a class="popup-youtube iteme" href="<?php echo $press->press_link ?>">  <div class="animated-css-play-button" style="left:50%!important">  <span class="play-icon"><i class="fa fa-play"></i></span></div>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="help-details d-block" style="border-left: 5px solid #0795fe;">
                                    ...
                                    <div class="content" >
                                        ...
                                        <font size="3rem"><b> {{$press->localeAll[0]->name}} </b></font> </br>
                                        <h4 class="hd-subtitle"> {{$press->localeAll[0]->function}} </h4>
                                        <br>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" style="height:70%">
                            ...
                            <div class="carousel-item  active">
                                <iframe class="video-player d-block w-100" width="120%" data-video-id="6oE6PuUzJg0" height="70%" src="https://www.youtube.com/embed/6oE6PuUzJg0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            ...
                            <div class="carousel-item">
                                <iframe class="video-player d-block w-100" width="120%" data-video-id="cn_4IBPUiBw" height="70%" src="https://www.youtube.com/embed/cn_4IBPUiBw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
