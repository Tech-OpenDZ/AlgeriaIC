...
<section class="discover-algeria" style="padding-top:0px;padding-bottom:0px;background-color:#ffffff!important">
    <div class="container_contact" style="max-width:100%!important">
      <div class="row" style="background-color:#ffffff;margin-left: -15px;margin-right: -15px">
                    <div class="discover_heading" style="height:400px; width:100%;padding-top:70px">
                        <div class="section_title" style="padding-top:125px">
                            <h2 class="subtitle align-content-center justify-content-center" style="color:#FFFFFF;font-weight:bold">@lang('discover_algeria.title')</h2>
                            ...
                            <div class="row">
                                <div class="reso_disc_left col-lg-3 col-md-3 col-sm-12 tabs-left">
                                    <div class="nav left-nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <a class="nav-link mt-2 active" id="" href="{{route('discover-algeria',$content->content_key)}}" role="tab" aria-controls="{{ str_replace(' ','_',$content->localeAll[0]->title) }}" aria-selected="{{ $loop->first ? 'true' : 'false' }}" style="box-shadow: 0px 10px 60px 0px rgb(0 0 0 / 10%)">
                                        {{ $content->localeAll[0]->title }}
                                        </a>
                                        @else
                                        <a class="nav-link mt-2" id="" href="{{route('discover-algeria',$content->content_key)}}" role="tab" aria-controls="{{ str_replace(' ','_',$content->localeAll[0]->title) }}" aria-selected="{{ $loop->first ? 'true' : 'false' }}" style="box-shadow: 0px 10px 60px 0px rgb(0 0 0 / 10%)">
                                        {{ $content->localeAll[0]->title }}
                                        </a>
                                        @endif
                                ...
                                <div class="reso_disc_right col-lg-9 col-md-9 col-sm-12">
                                    ...
                                    @foreach($algeria_content_as_per_key as $content)
                                        <div class="tab-pane fade show {{ $loop->first ? 'active' : ' ' }}" id="{{ str_replace(' ','_',$content->localeAll[0]->title) }}" role="tabpanel" aria-labelledby="{{ str_replace(' ','_',$content->localeAll[0]->title) }}-tab" style="box-shadow: 0px 10px 60px 0px rgb(0 0 0 / 10%);border-radius:10px">
