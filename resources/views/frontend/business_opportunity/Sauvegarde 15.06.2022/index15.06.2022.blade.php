...
<section class="business-opportunities">
    <div class="discover-algeria">
        ...
        <div class="row" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
            ...
            <div class="row" style=" margin-right:0px;margin-left:0px; background-color:#f5f5f5;box-shadow: 0px 0px 10px #C8C7D9;box-shadow: 0 0 10px 5px rgb(0 0 0 / 20%);border:0px solid black">
