...
class BusinessOpportunityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->where($boCondition);
        $business_opportunities = $business_opportunities->simplePaginate(8);
    ...
    public function create()
    {
        ...
        return view('frontend.business_opportunity.create',compact('sidebar_key'));
    }
    ...
    public function listUpcomingBusinessOpportunity(Request $request)
    {
        ...
        $upcoming_business_opportunity = $upcoming_business_opportunity->simplePaginate(8);
        $listFor = 'Upcoming business opportunity';
        $page = ($request->has('page') && !empty($request->get('page'))) ? $request->get('page'): 1;
