      ...
      /*  $this->validate($request, $rules, $messages, $attributes);
        ...
        if ($validator->fails()) {
            ...
            try{
                ...
                $customer ->payment_mode        = null;
                $customer ->company_type        = 'algerian';
                ...
                if ($customer -> save()) {
                    ...
                    return redirect('signup')->with('success',"Vous avez accomplis votre inscription avec succès 
                                                               Vous serez contacté incessamment par un commercial concernant notamment le paiement de votre abonnement
