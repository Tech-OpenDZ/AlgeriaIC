...
try {
    if (empty($request->file('file'))) {
        return back()->with('error', 'Aucun fichier selectionné');
    } else {
        request()->validate([
...
return redirect()->back()->with('error', "Veuillez vérifier la syntaxe des @ mail indiquées dans votre fichier / " . $th->getMessage());
}
