        ...
        if ($validator->fails()) {
            ...
            try{
                ...
                if ($customer->pays        != "Algérie") {
                    ...
                    return redirect('add')->with('success',"Abonnée ajouté avec succès !!!");
            }
            catch(Exception $e){
                return redirect('add')->with('error',"Opération echoué");
            }
        }
        /*$signupUserData = $request->all();
        $extra = [
    ...
    public function storePayment(Request $request)
    {
        try {
            ...
            */
            ...
            $customer ->email               = $signupUserData['email_customer'];
            $customer ->username            = $signupUserData['username'];
            $customer ->note                = $signupUserData['note'];
