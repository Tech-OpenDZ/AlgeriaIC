...
class PressController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            return Datatables::of($sections)
                ...
                ->rawColumns(['action','status','press_image'])
                ->make(true);
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $upload_path = storage_path('app/public/uploads/press/');
        ...
        foreach($press_data as $key => $value) {
            $press_tanslation = new AssistanceServiceTranslate;
            $press_tanslation->title = $value['name'];
            $press_tanslation->press_id = $press->id;
            $press_tanslation->description = $value['function'];
    ...
    public function edit($id)
    {
        ...
        foreach ($press_data->localeAll as $translate) {
            ...
            switch ($translate->locale) {
                case 'en':
                    $press_data->title_in_english = $translate->title;
                    $press_data->description_in_english = $translate->description;
                   
                    break;
                case 'fr':
                    $press_data->title_in_french = $translate->title;
                    $press_data->description_in_french = $translate->description;
                  
                    break;
                case 'ar':
                    $press_data->title_in_arabic = $translate->title;
                    $press_data->description_in_arabic = $translate->description;
    ...
    public function update(Request $request, $id)
    {
        ...
        $press_data->created_by = Auth::user()->id;
        $press_data->updated_by = Auth::user()->id;
