...
class ResourceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $customMessages = [
            ...
            'logo'                  => 'The picture must be a file of type: jpeg, jpg, png .',
        ];
        ...
        foreach($resource_data as $key => $value) {
            ...
            if ($request->hasFile('logo')) {
                ...
                $resource_tanslation->logo = $logoImageSaveAsName;
            }
            ...
            $resource->logo = $resource_tanslation->logo;
            $resource_tanslation->save();
        }

        if (isset($resource_tanslation->logo)) {
            $logoImage = $request->file('logo');
             $logoImageSaveAsName = time() . "_logo." . $logoImage->getClientOriginalExtension(); 
             $upload_path = storage_path('app/public/uploads/bus_logos/' . $resource_tanslation->id . '/logo/');
    ...
    public function edit(Request $request,$id)
    {
        ...
        if ($request->hasFile('logo')) {
            $logoImage = $request->file('logo');
            $logoImageSaveAsName = time() . "_logo." . $logoImage->getClientOriginalExtension();
            $upload_path = storage_path('app/public/uploads/bus_logos/'.$id.'/logo/');
