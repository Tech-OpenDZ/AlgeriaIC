...
<div class="card card-custom gutter-b" style="width: 100%;margin: 0 auto;">
    <div class="card-header">
        <div class="card-title" style="width: 100%;">
            <h3 class="card-label pull-left"  style="width: 100%;">Edit Frontend Permission</h3>
    ...
    <div class="card-body">
    {!! Form::model($frontendPermission, ['method' => 'PATCH','route' => ['manage-frontend-permission.update', $frontendPermission->id]]) !!}
