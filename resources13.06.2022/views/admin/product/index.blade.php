...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label">Manage Products</h3>
		</div>
		@can('product-create')
...
<div id="productModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form name='deleteProductForm' id='deleteProductForm'  method="POST">
                {{method_field('DELETE')}}
                {{ csrf_field() }}
...
$(function () {
    var table = $('#sector_datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "{{ route('manage-product.index') }}",
          data: function (d){
...
$(document).ready(function(){
	$('body').on('click', ".delete_product_btn", function(e) {
        e.stopPropagation();
        console.log($(this).data('href'));
        var del_id = $(this).data('id');
        $('#deleteProductForm').attr('action', $(this).data('href'));
