...
@section('content')
    ...
    <div class="pull-right">
        <a class="btn btn-primary" href="manage-prospect">Retour</a>
    ...
    <div class="container">
       ...
       <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-10 col-md-offset-1  col-sm-10 ">
            <div class="panel panel-info">
                 ...
                 <div class="panel-title" style="text-align: center">AJOUTER UN NOUVEAU PROSPECT </div>
            </div>

            <div class="panel-body" >
                <form id="" class="form-horizontal" role="form" method="post" action="{{ route('prospect-store') }}">
                    @csrf
                    ...
                    <div class="form-group row">
                                ...
                                <label for="contact-inquiry" class="label-text col-md-3"> L'inscrivant est un (e):  <span class="required" style="color: red">*</span></label>
                                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('name') is-invalid  @enderror" placeholder="Nom et Prénom " id="name" name="name" value="{{ old('name') }}">
                            @error('name')
                    ...
                    <div class="form-group">
                        <label for="companyName" id="companyNameLabel" class="label-text col-md-3"> Nom de l'entrprise <span class="required" style="color: red">*</span></label>
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('companyName') is-invalid  @enderror" placeholder="Nom de l'entrprise" id="companyName" name="companyName" value="{{ old('companyName') }}">
                            @error('companyName')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('jobTitle') is-invalid  @enderror" placeholder="Intitulé de poste " id="jobTitle" name="jobTitle" value="{{ old('jobTitle') }}">
                            @error('jobTitle')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('address') is-invalid  @enderror" placeholder="Adresse" id="address" name="address" value="{{ old('address') }}">
                            @error('address')
                    ...
                    <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <select name="pays" class="form-control" id="pays" onchange="choseCountry(this.value,0)">
                                                <option value="zz" selected disabled>Choisir ...</option>
                                    ...
                                    <label for= "wilaya" id="wilayaLabel" class="col-lg-2 col-form-label form-control-label" hidden>Wilaya <span class="required" style="color: red">*</span></label> </label>
                                    <div class="col-lg-3">
                                        ...
                                        <select name="wilaya" class="form-control" id="wilaya" hidden>
                  ...
                  <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="password" class="label-text col-md-3" hidden>@lang('signup.passwordLabel') <span class="required" style="color: red" >*</span></label>
                        <div class="col-md-9">
                            <div>
                        <input type="password" id="password-field"  class="form-control @error('password') is-invalid  @enderror" placeholder="@lang('signup.passwordLabel')" id="password" name="password" value="{{ old('password') }}" hidden> </div>
                            @error('password')
                    ...
                    <div class="form-group row">
                        <label for="provenance" class="label-text col-md-3">  Provenance <span class="required" style="color: red">*</span></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <label for="other_provenanceLabel" id="other_provenanceLabel" class="label-text col-md-3" hidden> Autres <span class="required" style="color: red">*</span></label>
                        <div class="col-md-9">
                            <input type="text" class="form-control @error('other_provenance') is-invalid  @enderror" placeholder="Autre Provenance " id="other_provenance" name="other_provenance" value="{{ old('other_provenance') }}" hidden>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <textarea  id="note-field" class="form-control @error('note') is-invalid  @enderror" placeholder="Commentaire" rows="6" name="note" value=""> </textarea>
    ...
    <script>
        document.getElementById('pays').onchange = function ()
        {
            ...
            else if ((this.value != 'Algérie'))
            {
                ...
                document.getElementById("wilaya").value = Null;
