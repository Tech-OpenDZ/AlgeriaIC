    ...
    <div class="container">
       ...
       <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-10 col-md-offset-1  col-sm-10 ">
            <div class="panel panel-info">
                 ...
                 <div class="panel-title" style="text-align: center">AJOUTER UN NOUVEAU CLIENT</div>
            </div>

            <div class="panel-body" >
                <form id="" class="form-horizontal" role="form" method="post" action="{{ route('customer-store2') }}">
                    @csrf
