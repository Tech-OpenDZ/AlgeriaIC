    ...
    <table class="headertoplink" style="border:0;background-color:rgba(255,255,255,0.2);color:#FFFFFF" width="100%">
        <tr>
            ...
            <td  style="text-align:right" style="background-color:#000000">
                ...
                <a  class="home_link" style="font-size:12px;color:#777a7c;font-weight:bold" href="{{ route('customer-home')}}">Home |</a>

                    <a class="nav-link1" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size:12px;color:#777a7c;font-weight:bold">@lang('footer.who_we_are') | </a>
          ...
          <!--      <a style="font-size:12px;color:#777a7c" href="{{ route('sitemap')}}">@lang('navbar.sitemap') | </a> -->
             	...
             	<a class="presse_link" style="font-size:12px;color:#777a7c;font-weight:bold" href="{{ route('presse')}}">@lang('navbar.presse') | </a>

                <a class="contact_link" style="font-size:12px;color:#777a7c;font-weight:bold" href="{{route('contactus')}}">@lang('navbar.contact') | </a>
                </font>
...
@if($linkedin_url != null)
                    <a href="{{ $linkedin_url }}" target="_blank"><i class="fab fa-linkedin-in" style="color:#777a7c"></i></a>&nbsp
                @endif

                @if($twitter_url != null)
                    <a href="{{ $twitter_url }}" target="_blank"><i class="fab fa-twitter" style="color:#777a7c"></i></a>&nbsp
                @endif
                @if($facebook_url != null)
                    <a href="{{ $facebook_url }}" target="_blank"><i class="fab fa-facebook-f" style="color:#777a7c"></i></a>&nbsp
                @endif

                @if($youtube_url != null)
                    <a href="{{ $youtube_url }}" target="_blank"><i class="fab fa-youtube" style="color:#777a7c"></i></a>&nbsp&nbsp
                @endif
            </td>
        </tr>
...
<li><a class="dropdown-item" href="{{route('premium-news-list')}}">@lang('home.premium')</a>
 ...
 <li style="float:right;color:#f9b634;border-bottom:2px solid #ffb400">
<a style="color:#f9b634!important" href="{{route('our-services')}}">@lang('navbar.ourServices')</a>
		</li>		   
