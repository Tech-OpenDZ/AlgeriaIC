...
@section('head')
    ...
    <title>{{str_limit($encoursEvent->localeAll[0]->title,50,'...')}} | @lang('news.placeName')</title>
    ...
    <section class="news-main-area">
        <div class="discover-algeria">
            <div class="container" style="padding-top:15px">
                <div class="row col-md-13 col-lg-13 col-sm-13" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    <div class="event_heading col-md-12" style="height:180px; width:100%">
                        <div class="section_title" style="padding-top:80px">
                            <h4 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">Évènements en cours</h4>
                           ...
                           @include('frontend.common.top_banner')
                            <section class="algeria-awards mt-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8 col-sm-10 awards-area__right">
                                            <div class="awards-content">
                                                <h1 class="main-heading">{{$encoursEvent->localeAll[0]->title}}</h1>
                                                <p class="awards-date">    {{Carbon\Carbon::parse(date('F jS, Y',strtotime($encoursEvent->start_date)))->isoFormat('LL')}}
                                                 | {{ $encoursEvent->localeAll[0]->place }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="awards-article">
                                    ...
                                    {!! str_replace('<p>&nbsp;</p>', "<br>", $encoursEvent->localeAll[0]->description) !!}

                                    {!! str_replace('<p>&nbsp;</p>', "<br>", $encoursEvent->localeAll[0]->event_summary) !!}
                                    </div>
                                    ...
                                    <p class="awards-heading-caption mb-4">{{$encoursEvent->localeAll[0]->place}} </p>
                                    {{-- <p class="awards-heading mb-2">@lang('past_event_detail.priceSquareMeter')</p> --}}
                                    {{-- <p class="awards-heading-caption">{{$encoursEvent->price_per_square_meter}}  DZD</p> --}}
                                    <ul>
                                    @foreach($encoursEvent->document as $document) 
                                    ...
                                    @if(!$encoursEvent->eventImage->isEmpty())
                                    <div class="invest-business-network">
                                        <div class="investment-post mb-3">

                                            <div class="row">
                                                @foreach($encoursEvent->eventImage as $image)
                            ...
                            <section class="algeria-awards mt-4">
                                <div class="awards-article">
                                    <h6 class="sub-heading mb-4">{{$encoursEvent->localeAll[0]->title}}</h6>
                                        ...
                                        <div class="organizer-contact">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-lg-8 col-sm-8 no-padding-left">
                                                    @if($encoursEvent->localeAll[0]->event_summary)
                                                    ...
                                                    @endif
                                                    @if(!$encoursEvent->eventExhibitor->isEmpty())
                                                    <a href="{{route('past-event-exhibitor-download', [$encoursEvent->id])}}" class="list-of-exhibitors mt-4">@lang('past_event_detail.listOfExhibitors') </a>
                                                    @endif
                                                </div>
                ...
                <!-- row ends here -->
                @if(!$encoursEvent->eventReference->isEmpty())
                ...
                <section class="brand-carousel">
                    ...
                    <div class="our-partners owl-carousel owl-theme brand-slider active" id="brands-demo">
                        @foreach($encoursEvent->eventReference as $reference)
