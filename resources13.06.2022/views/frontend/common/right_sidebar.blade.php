...
@else
    <div class="col-lg-3 col-md-3 sidebar-data new-sidebar">
                    ...
                    <div class="discover-algeria__right mt-4">
                        ...
                        <ul class="popular-articles">
                            ...
                            <li class="pop-listing">
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-2 listing-articles d-flex align-items-center">
                                        <h4 class="list-number">{{$loop->iteration}}</h4>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-10 listing-details">
