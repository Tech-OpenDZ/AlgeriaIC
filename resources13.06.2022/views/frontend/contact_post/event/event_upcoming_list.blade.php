...
@section('head')
    ...
    <title>@lang('upcoming_event.upcomingEvents') | @lang('news.placeName')</title>
                ...
                <div class="row col-md-13 col-lg-13 col-sm-13" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    <div class="event_heading col-md-12" style="height:180px; width:100%">
                        <div class="section_title" style="padding-top:80px">
                            <h4 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">@lang('upcoming_event.events')</h4>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="discover-algeria__left">
                           <!-- <ol class="breadcrumb-area">
                            <li class="breadcrumb-elements"><a href="#">@lang('upcoming_event.home')</a></li>
                                <li class="active">@lang('upcoming_event.events')</li>
                            </ol> -->
                           <!--<div class="business-banner">
                                @php
                                    $adv = getAdvertisement('top-header','events');
                                @endphp
                                @if($adv != null)
                                    @php
                                ...
                                <section class="search-engine news-select-area">
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-md-6 col-sm-6 col-12">
                                            <h6 class="main-heading">@lang('upcoming_event.upcomingEvents')</h6>
                                        </div> -->
                                        <div class="col-md-6 col-sm-6 col-12">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 week">
                                                    <p class="sortby">  @lang('upcoming_event.sortBy')</p>
                                                    <select name="sort_by" id="sort_by" class="select-button mb-2">
                                                        <option value="All">@lang('upcoming_event.allEvent')</option>
                                                        <option value="Week">@lang('upcoming_event.week')</option>
                                                        <option value="Month">@lang('upcoming_event.month')</option>
                                                        <option value="Year">@lang('upcoming_event.year')</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <section class="news-inside-post">
                                <div class="slider-area table-carousel">
                                    ...
                                    <div class="next-prev-controls-slide mt-4">
                                        ...
                                        <!--<button class="login-in" id="previous-page-news" style="{{ ($upcomingEvents->onFirstPage()) ? 'visibility:hidden;': ''}}">
                                        ...
                                        <button class="register" id="next-page-news" style="{{ (!$upcomingEvents->hasMorePages()) ? 'visibility:hidden;': ''}}">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '#previous-page-news', function(e){
                e.preventDefault();
                window.location.href = '{{route("upcoming-event-list")}}?page='+'{{$upcomingEvents->currentPage()-1}}&'+$('#search-news-form').serialize();
            });
            ...
            $(document).on( "submit", '#search-news-form', function(event){
                ...
                window.location.href = '{{route("upcoming-event-list")}}?page=1&'+$('#search-news-form').serialize();
            });

            $(document).on( "click", '#search-by-kw', function(event){
                event.preventDefault();
                window.location.href = '{{route("upcoming-event-list")}}?page=1&keyword='+$('#keyword').val();
            });

            $(document).on( "change", '#sort_by', function(event){
                window.location.href = '{{route("upcoming-event-list")}}?page=1&action=search-by-dates&sort_by='+$('#sort_by').val();
            });
