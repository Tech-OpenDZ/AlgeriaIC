            ...
            <div class="col-md-9 col-lg-9 col-sm-12">
                <div class="discover-algeria__left">
                    <ol class="breadcrumb-area">
                        <li class="breadcrumb-elements"><a href="#">@lang('discover_algeria.home')</a></li>
                        <li class="active">@lang('discover_algeria.discover_algeria')</li>
                    </ol>
                    ...
                    <div class="slider-area">
                        @include('frontend.banner.index', ['banner' => 'discover_algeria'])
                    </div>
                    <!-- slider ends here -->
                    ...
                    <section class="about-algeria">
                        <div class="about-algeria__elements">
                            <h1 class="main-heading mb-3">@lang('discover_algeria.title')</h1>
                            <!-- tabs structure starts here -->
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-12 tabs-left">
