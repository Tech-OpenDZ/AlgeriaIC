                ...
                <div class="content">
                    <div class="slideh current">
                        <div class="content col-sm-3 col-xs-3" >
                            <h5 class="head" style="color:#000000; background-color:#ffffff">Investir en Algèrie</h5>
                            <p class="text_head " style="color:#ffffff;font-weight:bolder;font-size:60px"> La Première Plateforme Dédiée à L’investissement en Algérie </p>
                            ...
                            <center>
                                <div class="">
                                    <ul>
                                        <li>
                                            <a class="btn_head" href="{{ route('gallery')}}" class="genric-btn success radius" style="background-color:#4e7cbe!important;cursor:pointer!important;float:left;font-weight:bold" >
                                                @lang('home.view_more')
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <div class="slideh">
                        <div class="content col-sm-3 col-xs-3">
                            <h5 class="head" style="color:#000000; background-color:#ffffff">Services d'Accompagnements</h5>
                            <p  class="text_head col-sm-9 col-xs-9" style="color:#ffffff;font-weight:bolder;font-size:60px">  Nos Compétences <br> au  Service  <br> des Investisseurs </p>
                            <br>
                            <br>
                            <center>
                    ...
                    <div class="slideh">
                        <div class="content">
                            <h5 class="head" style="color:#000000; background-color:#ffffff">Opportunités d'Affaires</h5>
                            <p  class="text_head col-sm-6 col-xs-6" style="color:#ffffff;font-weight:bolder;font-size:60px"> Porteurs de Projets ou Investisseurs, Découvrez Nos Opportunités </p>
                            <br>
                            <br>
                            <center>
                                <div class="">
                    ...
                    <div class="slideh">
                        <div class="content col-sm-3 col-xs-3">
                            <h5 class="head" style="color:#000000; background-color:#ffffff">Avis d'Experts</h5>
                            <p  class="text_head col-sm-9 col-xs-9" style="color:#ffffff;font-weight:bolder;font-size:60px">  Etat des Lieux <br>
                                et Projections Futures, <br>
                                Les Avis de nos Experts </p>
                            <br>
                            <br>
                            <center>
                                <div class="" style='position:absolute!important'>
            ...
            <section class="services" >
                <div class="service-item-container">
                    <div class="service-item" >
                        ...
                        <div class="p-30 pt-40" style="margin-left:20px">
                            <h6 class="font-weight-bold" style="font-weight: 700;line-height: 1.4;"> Marchés & Finances d’entreprise </h6>
                            <br>
                            <h6 style="margin-left:20px!important;color:#66788a;font-size:1rem;font-family:Poppins;font-weight: 400;line-height: 2"> Business report <br> Etude de marché <br> Audit et comptabilité...</h6>
                            <br>
                            <br>
                    ...
                    <div class="service-item">
                       ...
                       <br>
                        <div class="p-30 pt-40" style="margin-left:20px">
                            <h6 class="font-weight-bold"  style="font-weight: 700;line-height: 1.4;"> Conseil aux entreprises </h6>
                            <br>
                            <h6 style="margin-left:20px!important;color:#66788a;font-size:1rem;font-family:Poppins;font-weight: 400;line-height: 2">Assistance Administrative <br>  Assistance juridique <br> Conseil et assistance...</h6>
                            <br>
                            <br>
                    ...
                    <div class="service-item">
                        ...
                        <br>
                        <div class="p-30 pt-40" style="margin-left:20px">
                            <h6 class="font-weight-bold"  style="font-weight: 700;line-height: 1.4;"> Assistance des sociétés étrangères </h6>
                            <br>
                            <h6 style="margin-left:20px!important;color:#66788a;font-size:1rem;font-family:Poppins;font-weight: 400;line-height: 2">Représentation de sociétés <br> étrangères <br> Aide à l'exportation...</h6>
                            <br>
                            <br>
                            <a  class="genric-btn success radius" href="{{route('our-services')}}" style="margin-left:20px">   @lang('home.view_more') ➞ </a>
                        </div>
                    ...
                    <div class="service-item">
                        ...
                        <br>
                        <div class="p-30 pt-40" style="margin-left:20px">
                            <h6 class="font-weight-bold"  style="font-weight: 700;line-height: 1.4;"> Assistance opérationnelle </h6>
                            <br>
                            <h6 style="margin-left:20px!important;color:#66788a;font-size:1rem;font-family:Poppins;font-weight: 400;line-height: 2">Implantation et logistique <br> Assistance aux salons <br> et expositions...</h6>
                            <br>
                            <br>
                            <a  class="genric-btn success radius" href="{{route('our-services')}}" style="margin-left:20px">   @lang('home.view_more') ➞ </a>
                        </div>
    ...
    <section class="algeria-home">
        <div class="container">
            <div class="title-headings">
                ...
                <br>
                <a href="{{route('business-opportunity')}}">  <h2 class="title";style="color:#092a49"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nos dernières annonces </font></font></h2> </a>
            </div>
            <br>
            <br>
            <div class="row">
...
<div class="about">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <h6 class="subtitle text-white ml-30" style="text-align:left;font-weight:800"> Nos Certifications</h6>
                <br>
                <h3 class=" text-white ml-30" style="text-align:left;font-weight:650">Qualité, Hygiène, Sécurité et Environnement</h3>
                <br>
                <br>
                <br>
                <div class="agency-wrapper ml-30">
                    ...
                    <div class="tm-sc-icon-box icon-box icon-left text-start iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-left pb-40 mb-40 border-bottom-light">
                        <div class="icon-box-wrapper">
                            ...
                            <div class="icon-text">
                                <a href="{{route('qhse')}}">   <h5 class="icon-box-title text-white mt-0" style="    font-family: Mulish, sans-serif ;font-weight: 700;line-height: 1.4; margin-bottom: 1rem;">Transition + Reconduction</h5> </a>
                                <div class="content">
                    ...
                    <div class="tm-sc-icon-box icon-box icon-left text-start iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-left border-bottom-dark">
                        <div class="icon-box-wrapper">
                            ...
                            <div class="icon-text">
                                <a href="{{route('qhse')}}">   <h5 class="icon-box-title text-white mt-0"  style="font-family: Mulish, sans-serif ;font-weight: 700;line-height: 1.4; margin-bottom: 1rem;">Reconduction</h5> </a>
                                <div class="content">
    ...
    <section class="algeria-home">
        <div class="container">
             <div class="title-headings">
                ...
                <br>
                <a href="{{route('premium-news-list')}}"> <h2 class="title";style="color:#092a49"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Les derniers avis</font></font></h2> </a>
            </div>
            <br>
            <br>
...
<div class="row" style="background: linear-gradient(#e8e8e8, #e8e8e8); left:5px;right:5px;padding-left:60px;padding-right:60px;padding-top: 120px;padding-top: 120px;padding-bottom:50px;
	box-shadow: rgba(17, 17, 26, 0.1) 0px 4px 16px, rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 56px;">
        ...
        <div class="col-lg-5 col-xl-5 col-sm-12">
              ...
              <div class=" tm-sc-video-popup tm-sc-video-popup-button-over-image mb-30">
                        ...
                        <div class="box-hover-effect tm-sc-video-popup tm-sc-video-popup-button-over-image mb-30">
                           <div class="effect-wrapper">
                            <div class="thumb">
                            <img class="img-fullwidth box-hover-effect" style="width:100%" src="{{asset('storage/uploads/video_presse/presse0706.jpg')}}">
                            </div>
                          </div>
                        </div>
                  <a class="popup-youtube iteme" href="https://www.youtube.com/watch?v=4mwbsgKwP_c">  <div class="animated-css-play-button" style="left:50%!important">  <span class="play-icon"><i class="fa fa-play"></i></span></div>
                </a>
            </div>
          </div>
                ...
                <div class="icon"> <h5 style="text-transform: uppercase;">Last Interview </h5></div>   
                     <font size="3rem"><b>  Tadjeddine BACHIR   </b></font> </br>
                    <h4 class="hd-subtitle"> Président du GAAN </h4>
                    <br>
            ...
            <div class="col-lg-7 col-xl-7 col-sm-12">
              ...
              <div class="about-box-contents" style="margin-top: -6px;">
                <div class="destails">
                 ...
                 <a href="{{route('presse')}}">   <h6 class="subtitle" style="text-align:left;    line-height: 1.4;margin-bottom: 1rem; margin-top: 0.75rem;">Espace Presse</h6> </a>
              
                 <a href="{{route('presse')}}">   <h2 class="title" style="text-align:left;font-weight: 800; line-height: 1.3; color: #092a49;"> Les interviews <br> by AlgeriaInvest</h2> </a>
                       ...
                       <!-- <ol class="carousel-indicators" style="bottom:170px">
                        ...
                        <div class="carousel-inner" style="height:70%">
                             ...
                             <div class="carousel-item active">
                                <iframe class="video-player d-block w-100" width="120%" data-video-id="YXx-gTUDc6k" height="70%" src="https://www.youtube.com/embed/wdcqO2u-7VM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                            </div>

                            <div class="carousel-item">
                                <iframe class="video-player d-block w-100" width="120%" data-video-id="cUABMUwym8U" height="70%" src="https://www.youtube.com/embed/4ZWJPePcRio" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                            </div>

                            <div class="carousel-item">
                                <iframe class="video-player d-block w-100" width="120%" data-video-id="tpoPgRwPlQY" height="70%" src="https://www.youtube.com/embed/sjRdQ53cN9g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                            </div>

                            <div class="carousel-item">
                                <iframe class="video-player d-block w-100" width="120%" data-video-id="3EZ0STFMxsE" height="70%" src="https://www.youtube.com/embed/HeQZxSf_qlw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                            </div>

                            <div class="carousel-item">
                                <iframe class="video-player d-block w-100" width="120%" data-video-id="tpoPgRwPlQY" height="70%" src="https://www.youtube.com/embed/GEt_9WAOl7Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
...
<div class="container">
    <div class="row event">
       ...
       <!-- <center> <div class="service-icon" style="background: #4e7cbe;border-radius: 12%;height: 150px;left: auto;line-height: 75px;    position: sticky;;right: 30px;top: 105px;width: 150px;transition: all 0.4s ease-in-out;"><div class="icon"> <img src="{{asset('storage/uploads/graphs/graph-6.png')}}" style="width:50px;height:50px;margin:10px" alt="eco-news" class="img-fluid eco-news-img"></div></div> </center> -->
        ...
        <br>
            <br>
          <a href="{{route('event-list')}}">   <h1 class="text-white ml-30" style="font-family: Mulish, sans-serif;text-align:left;margin-bottom: 1rem;margin-top: 0.75rem;font-weight: 800;font-size: 3.75rem;line-height: 1.3;"><center> Evènements et Salons </center>  <center>Save the date  </center> <center>Now  </center></h1>  
            <br>
            <br>
            <br>
            <br>
...
<div class="container" >
            <div class="row "class="mon-slide" >
             ...
             <div class="title-headings">
                ...
                <br>
                <a href="{{route('news-list')}}"> <h2 class="title";style="color:#092a49"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Les derniers articles</font></font></h2> </a>
            </div>
            <br>
             <br>
