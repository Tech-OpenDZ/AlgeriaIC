        ...
        <div class="discover-algeria" style="padding-top: 0px;padding-bottom: 0px;">
            ...
            <div class="container" style="max-width:100%">
                <div class="row align-content-center justify-content-center"  style=" left:0;right:0;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    ...
                    <div class="qhse_heading_new col-md-12" style="height:280px; width:100%;padding-top:70px">
                   
                        <div class="section_title text-center" style="padding-top:7px">
                          <h2 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;text-align:center;"> @lang('qhse.qhse_title')</h2>
