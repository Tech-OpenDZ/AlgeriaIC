        ...
        <div class="discover-algeria">
            <div class="container">
               ...
               <!-- <div class="section_title text-center">
                ...
                <div class="title-arrow" style="padding-top: 100px;background-position: 2% 45%;padding: 70px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                ...
                <div class="container">
                <div class="row align-content-center justify-content-center" style="background-color: #f5f5f5; box-shadow: 10px 10px 10px rgb(0 0 0 / 10%);">
                    ...
                    <div class="contact-form inline-list col-md-12 col-lg-5 col-sm-12 mb-5  mt-4 " style="background-color: #f9b634; text-align:center;color:#000000;text-transform: bold; text-shadow: 10px 10px 10px rgb(0 0 0 / 20%);box-shadow: 10px 10px 10px rgb(0 0 0 / 10%); ">
                        ...
                        <center><form action="{{ route('contactus-store')}}" method="post" role="form" name="">
                                ...
                                <h5 class="subtitle mb-1" style="color:#FFFFFF">@lang('inquiry.contact_us_desc')</h5>
                                <br><br>
