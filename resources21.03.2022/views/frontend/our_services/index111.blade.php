				...
				<section id="service">
					<div class="container">
						<div class="row" style="left:0;right:0 ;max-width: 100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
							<div class="serv_bac" style="height:180px">
								<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 section_title text-center" style="padding-top:80px">
									<h4 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">@lang('our_services.assistance_services')</h4>

								</div>

								<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 section_title" style="width:40%;float:right;padding-top:59px">
									<p style="color: #ffffff">@lang('home.services_sub_title')</p>
								</div>
							</div>
						</div>
												...
												<div class="modal-dialog modal-lg" role="document">
													<div class="modal-content">
														...
														<div class="modal-body" id="TheBodyContent">
															...
															<iframe width="100%" height="615" name="submitter" src="{{route('contact_post')}}">
