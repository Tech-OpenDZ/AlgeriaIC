...
@section('head')
    ...
    <title>@lang('privacy_policy.privacy_policy') | @lang('home.algeria_invest')</title>
        ...
        <div class="col-md-9 col-lg-9 col-sm-12">
                <div class="discover-algeria__left">
                    <ol class="breadcrumb-area">
                        <li class="breadcrumb-elements"><a href="#">@lang('privacy_policy.home')</a></li>
                        <li class="active">@lang('privacy_policy.privacy_policy')</li>
                    </ol>
                    ...
                    @if($content->isempty()) 
                        <br/>
                        <div class="alert-text">@lang('privacy_policy.content_error')</div>
                    @else
