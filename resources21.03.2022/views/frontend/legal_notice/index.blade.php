...
@section('head')
    ...
    <title>@lang('legal_notice.legal_notice') | @lang('home.algeria_invest')</title>
    ...
    <div class="row" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    <div class="business-heading" style="height:180px; width:100%;">
                        ...
                        <div class="section_title" style="padding-top:80px;width:50%; float:left;">
									<h4 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">@lang('legal_notice.legal_notice')</h4>
								</div>
        ...
        <div class="col-md-9 col-lg-9 col-sm-12">
                <div class="discover-algeria__left">
                    <ol class="breadcrumb-area">
                       <!-- <li class="breadcrumb-elements"><a href="#">@lang('legal_notice.home')</a></li> -->
                       <!-- <li class="active">@lang('legal_notice.legal_notice')</li>v -->
                    </ol>
                    ...
                    @if($content->isempty()) 
                        <br/>
                        <div class="alert-text"> @lang('legal_notice.content_error')</div>
                    @else
