...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'confirmation@algeriainvest.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Algeria Invest';
  ...
  protected function SmtpSend($header, $body) {
    require_once $this->PluginDir . '/var/www/vhosts/algeriainvest.com/httpdocs/AlgeriaIC/resources/views/frontend/signup/class/class.smtp.php';
    $bad_rcpt = array();
