                            ...
                            <br>
                                ...
                                <div class="form-check mb-2 mr-sm-2" >
                                    <label class="form-check-label">
                                        ...
                                        <p class="label-text-check" inline> &nbsp <strong>  <a href="#"  id="" class="label-text-check-anchor test">@lang('signup.view_payment_mode') (@lang('signup.algerianCompanies'))</a> </p> </strong>
                                        @error('company_type')
