                          ...
                          <br>
                                    ...
                                    <label class=""></label>
                                       ...
                                       <!-- <input class="btn btn-secondary" type="reset" value="Cancel"> -->
                                        <a href="{{route('customer-register')}}" type="button" class="btn-warning btn-lg"  style="border: 2px solid white;border-radius: 3px;color:#FFFFFF"> @lang('signup.register') </a>
