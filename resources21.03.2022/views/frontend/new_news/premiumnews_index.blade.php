...
@section('head')
    ...
    <title>@lang('resource.business_environment') | @lang('news.placeName')</title>
    ...
    <div class="discover-algeria">
        <div class="container" style="padding-top:15px">
                ...
                <div class="row col-md-13 col-lg-13 col-sm-13" style=" left:0;right:0;max-width:100%;margin-left: 0px;box-shadow: 10px 10px 10px rgb(0 0 0 / 20%)">
                    <div class="expert_heading col-md-12" style="height:180px; width:100%">
                        <div class="section_title" style="padding-top:80px">
                            <h4 class="subtitle mb-1" style="color:#FFFFFF; float:left;font-weight:bold;margin-left:50px">@lang('news.premiumNews')</h4>
                                    ...
                                    <div id="advanced_search_area">
                                        <div class="row" >
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                                ...
                                                <select name="zone[]"  multiple  class="multi-choice select-button mb-4" style="width: 100%;" data-placeholder="@lang('news.zone')" style='height:250px'>
                                        ...
                                        <div class="sr-btn">
                                            <button type="submit" class="common-button mt-2" id="news-search-form-submit" style="background-color:#f9b634; border:#f9b634">@lang('news.search')</button>
                                        </div>
                                    </div>
                            ...
                            <div class="slider-area table-carousel">
                                <div id="table-slide">
                                    ...
                                    <div class="carousel-inner" id="carousel-inner-data">
                                        @if ($latestNews != '')
                                        <h4 class="main-heading">@lang('news.latestNewsLabelexp')</h4>
