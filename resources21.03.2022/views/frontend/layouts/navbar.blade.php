...
<header>
    ...
    <div class="mid-header mid-headerN">
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-12">
                <div class="mid-header__left mid-header__leftN">
                    <a href="{{route('customer-home')}}" class="logo-class d-flex align-items-center">
                        <img src="{{ asset('css/images/logo_algeria_invest.svg')}}" alt="logo" class="img-fluid logo-for-mobile">
                    </a>
                        ...
                        <div class="site-user">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <button class="dropdown-item login_btn" type="button" id="mobile-login">@lang('navbar.toLoginIn')</button>
                ...
                <div class="col-lg-10 col-md-9 col-sm-12">
                    ...
                    <div class="mid-header__right">
                        ...
                        <ul class="mid-header__right--buttons">
                            ...
                            <li class="search">
                                <a href="javascript:void(0);" class="search-form-tigger" data-toggle="search-form" id="searchFormOne">
                                    <img src="{{asset('css/images/search.svg')}}" alt="search" class="img-fluid">
                                </a>
                                <a href="{{route('search')}}" id="searchFormTwo" style='display:none;'>
                                    <img src="{{asset('css/images/search.svg')}}" alt="search" class="img-fluid" >
                                </a> 
            ...
            <div class="search-form-wrapper">
                ...
                <form class="search-header-form" method="get" action="{{route('search')}}">
                    <div class="newSearch">    
                        <button type="submit" class="header-search-btn"><i class="fa fa-search"></i>
                        </button>
                        <input type="hidden" name="_token" value="3sdhSaOUIExthWYi4zQBA4umcTToLKYrhc1X89A4" id="search-text">                    
                        <input autofocus type="search" placeholder="@lang('news.keywordPlaceholder')" id="search-box" name="search" class="header-search">
                    </div>
                </form>
            </div>
 ...
 <script>
    $("#searchFormOne").click(function(){

        $("#searchFormOne").css('display','none');
        $("#searchFormTwo").css('display','block');
