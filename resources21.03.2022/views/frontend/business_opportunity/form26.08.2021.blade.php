        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 mt-3">
                    ...
                    <input type="text" class="form-control @error('company_email') is-invalid  @enderror" placeholder="" id="company_email" name="company_email" value="{{ old('company_email') }}" required='required' data-parsley-required-message='Company_email is required' data-parsley-trigger='change focusout' data-parsley-minlength='2' data-parsley-maxlength='190' data-parsley-class-handler='#company_email'>
                    @error('company_email')
                    <span class="invalid-feedback" role="alert">
                    {{ $message }}
                </span>
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 mt-3">
                    ...
                    <input type="text" class="form-control @error('company_contact') is-invalid  @enderror" placeholder="" id="company_contact" name="company_contact" value="{{ old('company_contact') }}" required='required' data-parsley-required-message='Company_contact is required' data-parsley-trigger='change focusout' data-parsley-minlength='2' data-parsley-maxlength='190' data-parsley-class-handler='#company_contact'>
