		...
		<div class="signup-form-area pb-4">
			<div class="container pt-3">
				<div class="signup-form-area__elements text-left pt-4">
					<h4 class="main-heading mb-3">@lang('newsletter.sub-resource-heding')</h4>
					<p class="mb-3">@lang('newsletter.resource-subheading')</p>
                    ...
                    {!! Form::open(['method' => 'post', 'route' => 'resource-store', 'class' => 'form-horizontal,submit_bannerform' ,'id' => 'bannerForm','files' => true]) !!}
                    <div class="row">
