...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label">Manage Subscription</h3>
		</div>

		{{-- @can('subscription-create')
		<div class="card-toolbar">
			<a href="{{route('manage-subscription.create')}}" class="btn btn-primary">
        ...
        <div class="modal-content">
            <form name='deleteSubscriptionForm' id='deleteSubscriptionForm'  method="POST">
                ...
                <div class="modal-body">
                    <p>Are you sure want to delete this subscription plan?</p>
                </div>
...
$(function () {
    var table = $('#subscription_datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "{{ route('manage-subscription.index') }}",
          data: function (d){
