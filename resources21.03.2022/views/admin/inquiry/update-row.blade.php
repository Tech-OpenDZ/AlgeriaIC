...
@section('content')
    ...
    <div class="pull-right">
        <a class="btn btn-primary" href="{{ route('manage-inquiry.index')  }}">Retour</a>
            ...
            <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-10 col-md-offset-1  col-sm-10 ">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="panel-title" style="text-align: center">AJOUTER UN COMMENTAIRE POUR LA DEMANDE </div>
                    </div>

                    <div class="panel-body" style="center:center">

                        <form id="" class="form-horizontal" role="form" method="post" action="{{ route('rowUpdate') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('username') is-invalid  @enderror"  id="username" name="username" value="{{$row->username}}" readonly>
                                    @error('username')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('email') is-invalid  @enderror"  id="email" name="email" value="{{ $row->email}}" readonly>
                                    @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('company') is-invalid  @enderror"  id="company" name="company" value="{{$row->company }}" readonly>
                                    @error('company')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('job_title') is-invalid  @enderror"  id="job_title" name="job_title" value="{{ $row->job_title }}" readonly>
                                    @error('job_title')
                          ...
                          {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('phone_number') is-invalid  @enderror"  id="phone_number" name="phone_number" value="{{ $row->phone_number }}" readonly>
                                    @error('phone_number')
                            ...
                            <div class="form-group">
                                <label for="subject" class="label-text col-md-3">Sujet <span class="required" style="color: red">*</span></label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('subject') is-invalid  @enderror"  id="subject" name="subject" value="{{ $row->subject }}" readonly>
                                    @error('subject')
                                    <span class="invalid-feedback" role="alert" id="subject-validation-error">
                            {{ $message }}
                        </span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea  id="message-field" class="form-control @error('message') is-invalid  @enderror" rows="6"  name="message" value="" readonly> {{ $row->message }} </textarea>
                                    @error('message')
                            ...
                            <div class="form-group">
                                <label for="note_inquiry" class="label-text col-md-3"> Commentaire <span class="required" style="color: red">*</span></label>
                                <div class="col-md-9">
                                    <textarea  id="note-field" class="form-control @error('note_inquiry') is-invalid  @enderror"  rows="6" placeholder="note_inquiry" name="note_inquiry" value=""> {{ $row->note_inquiry }} </textarea>
                                    @error('bote_confirmation')
                                    <span class="invalid-feedback" role="alert" id="note_inquiry-validation-error">
                            {{ $message }}
                        </span>
                                    @enderror
                                </div>
