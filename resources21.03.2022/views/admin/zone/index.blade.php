...
@php
    if (\Auth::user()->can('zone-edit') || \Auth::user()->can('zone-delete')) {
        $actionEnable = true;
    }
    else {
        $actionEnable = false;
...
<div class="card card-custom">
	<div class="card-header">
		...
		<div class="card-toolbar">
			<a href="{{route('manage-zone.create')}}" class="btn btn-primary">
   		...
   		<div class="dataTables_wrapper dt-bootstrap4 no-footer">
   			<div class="row">
   				<div class="col-sm-12 table-responsive">
		   			<table class="table table-bordered table-hover table-checkable" id="zone_datatable">
...
$(function () {
    var table = $('#zone_datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          url: "{{ route('manage-zone.index') }}",
          data: function (d){
