...
@php
if (\Auth::user()->can('page-content-edit') || \Auth::user()->can('page-content-delete')) {
    $actionEnable = true;
}
else {
    $actionEnable = false;
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            <div class="card-title">
                <h3 class="card-label">Manage Content
            </div>
            @can('page-content-create')
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('manage-content.create')}}" class="btn btn-primary">
                    New Content
                </a>
                <!--end::Button-->
            </div>
...
@section('sctipts')
     ...
     <!-- Content Delete confirmation model -->
    <div id="deleteContentModal" class="modal fade delete_admin_btn" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form name='deleteContentForm' id='deleteContentForm'  method="POST">
                    {{method_field('DELETE')}}
                    {{ csrf_field() }}
    ...
    <script>
        ...
        $(document).on('click', ".delete_admin_btn", function(e) {
            ...
            $('#deleteContentForm').attr('action', $(this).data('href'));
