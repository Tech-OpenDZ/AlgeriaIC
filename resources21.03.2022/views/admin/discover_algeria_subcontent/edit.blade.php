...
<div class="card card-custom gutter-b" style="width: 100%;margin: 0 auto;">
    <div class="card-header">
        <div class="card-title" style="width: 100%;">
            <h3 class="card-label pull-left"  style="width: 100%;">Edit Discover Algeria Content</h3>
    ...
    <div class="card-body">
    {!! Form::open(array('method'=>'POST','route' => ['manage-algeria-subcontent.update',$algeria_content->id],'files'=>true)) !!}
    {{ method_field('PATCH') }} 
