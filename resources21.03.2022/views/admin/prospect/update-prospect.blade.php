        ...
        <div class="card-body">
            ...
            <div class="panel panel-info">
             ...
             <div class="panel-body" >
                <form  class="form-horizontal" role="form" method="post" id="update-prospect-data-form" name="update-prospect-data-form" action="{{route('updatProspect')}}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="hidden" class="form-control @error('id') is-invalid  @enderror" placeholder="Inscription id " id="id" name="id" value="{{$prospect->id}}">
                    ...
                    <p class="mb-7 mt-3"><strong>Date de création :  </strong>{{date('d M Y',strtotime($prospect->created_at))}}</p>


                    <div class="form-group">
                        <label for="name" class="label-text col-md-3"> Nom et Prénom <span class="required" style="color: red">*</span></label>
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('name') is-invalid  @enderror" placeholder="Nom et Prénom " id="name" name="name" value="{{$prospect->name}}">
                            @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('companyName') is-invalid  @enderror" placeholder="Nom de l'entrprise" id="companyName" name="companyName" value="{{$prospect->company_name}}">
                            @error('companyName')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('jobTitle') is-invalid  @enderror" placeholder="Intitulé de poste " id="jobTitle" name="jobTitle" value="{{$prospect->job_title}}">
                            @error('jobTitle')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('address') is-invalid  @enderror" placeholder="Adresse" id="address" name="address" value="{{$prospect->company_address}}">
                            @error('address')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="pays" class="form-control" id="pays" onchange="choseCountry(this.value,0)" value="{{$prospect->pays}}">

                                <option value="" disabled>@lang('signup.choose') ...</option>
                                <option value="{{$prospect->pays}}" selected>{{$prospect->pays}} </option>
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="wilaya" class="form-control" id="wilaya"  value="{{$prospect->wilaya}}">
                                <option value=""> @lang('signup.choose')...</option>
                                <option value="{{$prospect->wilaya}}" selected>{{$prospect->wilaya}} </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('phone') is-invalid  @enderror" placeholder="@lang('signup.mobileNumberLabel')" id="phone" name="phone" value="{{$prospect->mobile_number}}">
                            @error('phone')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="email" class="form-control @error('email_customer') is-invalid  @enderror" placeholder="@lang('signup.emailAddressLabel')" id="email_customer" name="email_customer" value="{{$prospect->email}}">
                   ...
                   <!-- <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" class="form-control @error('username') is-invalid  @enderror" placeholder="@lang('signup.userNameLabel')" id="username" name="username" value="{{$prospect->username}}">
                            @error('username')
                   ...
                   <!-- <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div>
                        <input type="password" id="password-field"  class="form-control @error('password') is-invalid  @enderror" placeholder="@lang('signup.passwordLabel')" id="password" name="password" value="{{$prospect->password}}"> <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span> </div>
                            @error('password')
                   ...
                   <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <textarea  id="note" class="form-control @error('note') is-invalid  @enderror" placeholder="note" rows="5" name="note" value="{{$prospect->note}}"> {{$prospect->note}} </textarea>
                            @error('password_confirmation')
